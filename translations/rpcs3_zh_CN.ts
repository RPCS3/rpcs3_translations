...
<TS version="2.1" language="zh-CN" sourcelanguage="en">
  ...
  <context>
    ...
    <message>
      ...
      <translation>PS3 用户界面（XMB，或 VSH）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>PSP 重制版</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>输入 %0 到 %1，超时于 %2 %3</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/emulated_logitech_g27_settings_dialog.cpp" line="326"/>
      <source>axis</source>
    ...
    <message>
      ...
      <translation>按键/方向键</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/emulated_logitech_g27_settings_dialog.cpp" line="326"/>
...
Current location:
%0</source>
      <translation>RPCS3 切勿从 OneDrive 路径运行！
请将 RPCS3 移至未被 OneDrive 同步的目录。
当前位置：
%0</translation>
    </message>
    <message>
...
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
      <translation>这些库默认为 LLE 模式（下方列表），选择后将切换至 HLE。
LLE——“低阶模拟”，直接调用所选 SPRX 文件内的函数代码用于实现导出固件函数的功能。
HLE——“高阶模拟”，改为采用模拟器端的代码用于实现导出固件函数的功能。
如果选择错误，游戏将无法运行！如果不确定，请将两个列表都留空。将所有 SPRX 文件设为高级模拟模式时，模拟器无需安装固件即可启动。（实验性功能）</translation>
    </message>
    <message>
...
HLE - &quot;High Level Emulated&quot;, alternative emulator code will be used instead for exported firmware functions.
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
      <translation>这些库默认为 HLE 模式（上层列表），选择后将切换至 LLE。
LLE——“低阶模拟”，直接调用所选 SPRX 文件内的函数代码用于实现导出固件函数的功能。
HLE——“高阶模拟”，改为采用模拟器端的代码用于实现导出固件函数的功能。
如果选择错误，游戏将无法运行！如果不确定，请将两个列表都留空。将所有 SPRX 文件设为高级模拟模式时，模拟器无需安装固件即可启动。（实验性功能）</translation>
    </message>
...
Causes some software to behave differently than on retail hardware.</source>
      <translation>增加系统可用内存量，以匹配 DECR 主机（即开发机）及更多（其他未知主机）。
这会使得一些软件的表现与在零售版硬件上的有所不同。</translation>
    ...
    <message>
      ...
      <translation>在 SPU 的 MFC_GETLLAR 和 MFC_PUTLLUC 操作期间，强制 RSX 暂停。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="30"/>
      <source>Accurately processes SPU DMA operations.</source>
      <translation>精确处理 SPU 的 DMA 操作。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
      <translation>历史选项。在 PPU LLVM 的非 Java 模式下修正结果向量值。
如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
You shouldn&apos;t disable it if your CPU supports FMA.</source>
      <translation>在 PPU 和 SPU 后端中使用精确的双精度 FMA 指令。
如果你的 CPU 不支持 FMA，禁用此选项可能会带来一定的性能提升，但也可能引入原本不会出现的细微错误。
如果你的 CPU 支持 FMA，请不要禁用此选项。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="33"/>
      <source>Fixup NaN results in vector instructions in PPU backends.
If unsure, do not modify this setting.</source>
      <translation>在 PPU 后端的向量指令中修复 NaN 结果。
如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
      ...
      <translation>游戏启动后停止写入任何日志。除非你认为必要，否则不要使用。</translation>
    </message>
    <message>
...
This can fix graphics corruption observed when Read Color or Read Depth options are enabled.</source>
      <translation>在将 GPU 数据写入 VM 内存时，遵循 RSX 内存分层配置。这可以修复启用「读取颜色」或「读取深度」选项时观察到的图形损坏问题。</translation>
    </message>
    <message>
      ...
      <translation>禁用从数据目录中的着色器缓存加载和保存着色器。</translation>
    </message>
    <message>
      ...
      <translation>允许主机 GPU 直接与 CELL 同步。此选项会导致性能下降，但能够将 GPU 对象的真实状态暴露给主机 CPU。有助于消除视觉上的噪声和闪烁现象，会导致性能下降。谨慎使用。</translation>
    </message>
    <message>
...
This option incurs a performance penalty as well as the risk of visual artifacts but can yield crisper visuals when MSAA is enabled.</source>
      <translation>强制多重采样抗锯齿（MSAA）使用主机 GPU 的分辨率进行全部采样操作。
此选项会导致性能下降，并可能产生视觉瑕疵，但在启用 MSAA 时，可以提供更清晰的图像。</translation>
    </message>
    <message>
...
This option is only needed by developers to debug problems with texture cache memory protection.</source>
      <translation>强制主机的内存管理调用进入队列，而非以异步方式处理。
可能会导致许多游戏的性能大幅下降和卡顿。
此选项仅适用于开发人员调试纹理缓存内存保护错误。</translation>
    </message>
    <message>
...
This option is only needed for a select number of games.</source>
      <translation>禁用 SPU GETLLAR spin 优化。
可能导致许多游戏性能大幅下降和卡顿。
此选项仅适用于几款特定游戏。</translation>
    </message>
    <message>
...
This increases CPU usage, this setting is beneficial for high-threaded CPUs (12+) with select number of games.</source>
      <translation>启用 SPU RdEventStat spin。
此选项会增加 CPU 使用，只在多线程 CPU（12+ 核心）上有增益，且仅限于几款特定游戏。</translation>
    </message>
    <message>
...
· Relaxed changes the synchronization method completely and can greatly improve performance in some games or completely break others.</source>
      <translation>改变 ZCULL 报告的同步行为。请尝试不同选项，为你的游戏找到最佳设置。大多数游戏推荐使用“近似”（Approximate）模式。
· 精确（Precise）最贴近 PS3 的实际行为。部分游戏（如《恶魔之魂》和《黑暗地带》）需要此模式才能获得准确的画面效果。 
· 近似（Approximate）生成遮挡数据的速度更快，但结果可能与 PS3 不完全一致。适用于大多数 PS3 游戏。 
· 宽松（Relaxed）完全改变同步方式，可在某些游戏中显著提升性能，但也可能导致其他游戏完全无法正常运行。</translation>
    </message>
    <message>
...
Limiting the number of threads is likely to cause crashes; it&apos;s recommended to keep this at the default value.</source>
      <translation>限制每个线程组中的最大 SPURS 线程数。
部分情况下可以提高性能，尤其是在硬件线程数量有限的系统上。
限制线程数可能会导致崩溃；建议保持为默认值。</translation>
    </message>
    <message>
...
Can affect performance in unexpected ways.</source>
      <translation>更改睡眠周期的精度。
“As Host”使用操作系统默认的精确度，而 “All Timers”则会尝试改善它。
“Usleep Only”将限制调整仅针对 usleep 系统调用（syscall）。
可能会以难以预料的方式影响性能。</translation>
    </message>
    <message>
...
&quot;Atomic &amp; Ordered&quot; is the most accurate but it is the slowest and without much stability benefit in games.</source>
      <translation>”快速“为准确度最低的设置，RSX 不模拟原子 FIFO 缓冲区。
”原子“在多数游戏中显著提升稳定性，性能开销极小。
”原子 &amp; 有序“最为准确，但速度最慢，且在多数游戏中对稳定性提升不明显。</translation>
    </message>
    <message>
...
Affects timing of events which rely on these signals.</source>
      <translation>调整模拟器发送 VBLANK 信号的频率。
影响依赖这些信号进行定时的事件。</translation>
    </message>
    <message>
...
Known to fix the rhythm game Space Channel 5 Part 2</source>
      <translation>将 VBLANK 频率乘以 1000/1001，以得到如 59.94 Hz 这样的数值。
已知该方法可修复节奏游戏《太空频道 5：第二章》。</translation>
    </message>
    <message>
...
Affects software which uses system time to calculate things such as dynamic timesteps.</source>
      <translation>更改模拟系统时间的缩放比例。
会影响使用系统时间进行计算的软件，例如动态时间步长。</translation>
    </message>
    <message>
...
It is recommend to adjust this at 20µs to 40µs increments until the best value for optimal stability is reached.</source>
      <translation>控制 Cell 处理器唤醒后，RSX 开始处理所需的时间。
增加唤醒延迟可提高稳定性，但过高的值可能会降低 RSX/GPU 性能。
建议以 20μs 到 40μs 的增量进行调整，直到获得最佳稳定性。</translation>
    </message>
    <message>
...
Right-click a game in the game list and choose &quot;Configure&quot; instead.</source>
      <translation>不要在全局范围内更改此设置。
请在游戏列表中右键单击的一个游戏，然后选择“设置”。</translation>
    </message>
    <message>
...
Use &apos;Fast&apos; to use a faster but hacky version. This option is internally disabled for NVIDIA GPUs due to causing GPU hangs.</source>
      <translation>决定在使用异步流式传输时如何调度 GPU 异步计算任务。 
使用“安全”（Safe）模式可获得更符合规范的行为，但会带来一定的 CPU 开销。此设置适用于所有设备。 
使用“快速”（Fase）模式则采用更快但非标准的实现方式。由于会导致 NVIDIA 显卡假死，该选项在 NVIDIA GPU 上已被内部禁用。</translation>
    </message>
    <message>
...
Disabling it may fix some artifacts, especially on Apple GPUs, at the cost of performance.</source>
      <translation>为 MSL 着色器禁用快速数学计算，因为它可能会违反 IEEE 754 标准。
禁用此选项可能会以牺牲性能为代价修复某些组件问题，尤其是在 Apple GPU 上。</translation>
    </message>
    <message>
...
Do note that the savestate file is not gone completely, just ignored by RPCS3. You can manually relaunch it if needed.</source>
      <translation>开启此模式，模拟器将在保存进度后退出，并在加载保存进度后隐藏即时存档文件，防止 RPCS3 重新使用。
此模式提供让玩家忘记模拟器的体验：若您不希望在玩游戏时通过存档文件使用SL大法作弊，可考虑使用此模式。
请注意，此选项只是隐藏了模拟器即时存档文件并未删除，必要时可以手动读档。</translation>
    </message>
    <message>
...
When this mode is off, some games may not allow making a savestate and show an SPU pause error in the log.</source>
      <translation>开启此模式时，SPU 模拟器会优先考虑即时存档兼容性，这可能会稍微降低性能。
关闭此模式时，一些游戏可能无法创建即时存档，并在日志中显示 SPU 暂停错误。</translation>
    </message>
    <message>
...
This allows players to prepare for gameplay without being thrown into the action immediately.</source>
      <translation>开启此模式时，会在加载即时存档后暂停在第一帧。
玩家可以在读档后有时间为游戏做好准备，避免因立即进入游戏而手忙脚乱。</translation>
    </message>
    <message>
...
Enable only at a developer&apos;s request because when enabled it reduces performance a bit by itself.</source>
      <translation>启用后，会在运行时测量 SPU 性能。
此选项仅适用于开发人员，启用此选项后会略微降低性能。</translation>
    </message>
    <message>
...
For games with very high framerates, this option can result in worse performance for all GPU vendors.
      ...
      <translation>启用后，Vulkan 将尝试使用 PCI-e 可调整大小的基址寄存器地址空间上传 GPU 时间敏感数据。
当基准帧率较低时，可以大幅提示 NVIDIA 显卡的性能。
对于帧率极高的游戏，此选项可能会导致各厂商的 GPU 性能均出现下降。</translation>
    </message>
    <message>
...
XAudio2 uses native Windows sounds system and is the next best alternative.</source>
      <translation>Cubeb 使用跨平台方法并支持音频缓冲，因此是最佳选项。
XAudio2 使用原生 Windows 声音系统，是次优先的替代方法。</translation>
    </message>
    <message>
...
If it&apos;s not available, FAudio could be used instead.</source>
      <translation>Cubeb 使用跨平台方法并支持音频缓冲，因此是最佳选项。
如果不可用，可选择 FAudio 作为替代方案。</translation>
    </message>
    <message>
...
游戏使用 CellAudio，而 VSH 需要 RSXAudio。</translation>
    ...
    <message>
      ...
      <translation>将所有音频保存为原始 wave 文件。如果不确定，请勿选中此选项。</translation>
    </message>
    <message>
...
Use with buggy audio drivers if you have no sound or completely broken sound.</source>
      <translation>使用 16 位音频采样，而非默认的 32 位浮点采样。
如果你安装了有问题的音频驱动，导致一点声音也听不到或声音完全被破坏，可尝试此选项。</translation>
    </message>
    <message>
...
The manual setting will use your selected formats while the automatic setting will let the game choose from all available formats.</source>
      <translation>确定模拟的音频格式。
如需在立体声与环绕声之间切换，请设置此选项。
更改这些设置需要重启游戏。
手动设置将使用你选择的格式，自动设置则由游戏从所有可用格式中自行选择。</translation>
    </message>
    <message>
...
Use &apos;Auto&apos; to let RPCS3 decide the best format based on the audio device and the emulated audio format.</source>
      <translation>确定 RPCS3 的声音格式。
选择“自动”让 RPCS3 根据音频设备及模拟的音频格式自动选择最佳格式。</translation>
    </message>
    <message>
...
Values above 100% might reduce the audio quality.</source>
      <translation>控制模拟器的全局音量。
设定值超过 100% 可能会导致音频质量下降。</translation>
    </message>
    <message>
      ...
      <translation>启用音频缓冲，这会减少爆音/卡顿，但会增加音频延迟。</translation>
    </message>
    <message>
...
Higher values make the buffering algorithm&apos;s job easier, but may introduce noticeable audio latency.</source>
      <translation>目标缓冲区持续时间（毫秒）。
值越高，缓冲算法的工作越轻松，但可能导致明显的音频延迟。</translation>
    </message>
    <message>
...
Reduces crackle/stutter further, but may cause a very noticeable reduction in audio quality on slower CPUs.</source>
      <translation>启用时间拉伸功能——需要启用缓冲。
可进一步减少爆音/卡顿，但在较慢的 CPU 上可能会导致音频质量明显下降。</translation>
    </message>
    <message>
      ...
      <translation>缓冲填充水平（百分比），低于此值时将开始时间拉伸。</translation>
    </message>
    <message>
...
Rocksmith should be used with a Rocksmith dongle.</source>
      <translation>推荐大多数游戏选择“标准”选项。
“星声传情麦克风（模拟）”模拟了一个星声传情麦克风设备，适用于星声传情系列游戏。
“星声传情麦克风（真实）”仅适用于使用真实的星声传情麦克风设备游玩星声传情系列游戏。
“摇滚史密斯”需要搭配 Rocksmith 加密狗使用。</translation>
    </message>
    <message>
      ...
      <translation>解释器（慢）。
如果 PPU 解释器的重编译器（LLVM）无法运行，可尝试此选项。</translation>
    </message>
    <message>
      ...
      <translation>备用解释器（慢）。
可能比静态解释器更快。如果 PPU 解释器的重编译器（LLVM）无法运行，可尝试此选项。</translation>
    </message>
    <message>
...
If unsure, use this option.</source>
      <translation>在首次运行游戏前，会使用 LLVM 重编译器对游戏的 PPU 代码进行一次重新编译并缓存。
这是目前最快的选项，应该始终使用。
如果遇到兼容性问题，请改用另一项解释器并重新尝试。
...
Only disable this if you want to get ingame more quickly.</source>
      <translation>启动时搜索游戏目录，并预编译额外的 PPU 和 SPU 模块。
若禁用此项，这些模块将在需要时才进行编译。根据游戏的不同，可能导致游戏过程意外且频繁地中断。
仅在希望更快进入游戏时才禁用此项。</translation>
    </message>
    <message>
      ...
      <translation>解释器（慢）。
如果 SPU 解释器的重编译器（LLVM）无法工作，可以尝试此选项。</translation>
    </message>
    <message>
      ...
      <translation>替代解释器（慢）。
可能比静态解释器更快。如果 SPU 重编译器（LLVM）无法运行，可尝试此选项。</translation>
    </message>
    <message>
...
If unsure, use this option.</source>
      <translation>使用 ASMJIT 重编译器重新编译游戏的 SPU 代码。
这是速度较快且兼容性很好的选项。
如果不确定，请使用此选项。</translation>
    </message>
    <message>
...
If you experience issues, use the ASMJIT Recompiler.</source>
      <translation>在运行前使用 LLVM 重编译器重新编译并缓存游戏的 SPU 代码，这会增加额外的启动时间。
这是速度最快的选项，且兼容性非常好。
...
This setting is only applied when SPU Decoder is set to Dynamic or LLVM.</source>
      <translation>控制 SPU 浮点向量处理的精度。
以牺牲性能为代价修复了多款游戏（运行时）的问题。
此设置仅在 SPU 解码器设为动态（Dynamic）或 LLVM 时生效。</translation>
    </message>
    <message>
...
Changing the thread scheduler is not supported on CPUs with less than 12 threads.</source>
      <translation>控制 RPCS3 如何利用系统的线程。
每个选项均高度依赖于（要运行的）游戏和你的 CPU。建议尝试各项设置，以找出性能最佳的选项。
在线程数少于 12 的 CPU 上，不支持更改线程调度程序。</translation>
    </message>
    <message>
...
May cause severe audio stuttering in rare cases.</source>
      <translation>尝试检测 SPU 内核中的循环条件，并将其用作调度提示。
可以提升性能并降低 CPU 使用率。
在极少数情况下，可能会导致严重的音频卡顿。</translation>
    </message>
    <message>
...
Use the Safe mode for maximum compatibility.</source>
      <translation>此选项控制 SPU 分析器，尤其是编译单元的大小。“巨大”（Mega）和“极大”（Giga）模式可通过合并较小的单元来减少编译单元数量、增大单个单元尺寸，从而可能提升性能。 
如需最高兼容性，请使用“安全”（Safe）模式。</translation>
    </message>
    <message>
...
Leave this on auto if performance is negatively affected when setting a small value.</source>
      <translation>部分 SPU 阶段对竞争条件敏感，限制同时运行的数量有助于缓解性能卡顿。
将此项设为较小数值可能在某些游戏中提升性能并减少卡顿。
若设置较小值后性能下降，请将选项保持为自动。</translation>
    </message>
    <message>
...
The lighter the game is on the hardware, the more power is saved by it. (until the preemption count barrier is reached)</source>
      <translation>降低 CPU 使用率和功耗，从而延长移动设备的电池续航时间。（0 表示禁用）
数值越高，省电效果越明显，但可能导致音频或性能问题。建议值不超过 50。 
此选项会在帧率稳定时强制限制 FPS。
游戏对硬件负载越轻，该功能节省的电量就越多（直至达到抢占计数上限）。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="100"/>
      <source>Leave this enabled unless you are a developer.</source>
      <translation>除非你是开发人员，否则请保持选项启用。</translation>
    </message>
    <message>
...
Only useful to developers.
Never use this.</source>
      <translation>设置特殊的 MXCSR 标志以调试 SSE 操作中的错误。
仅在 PPU 线程不精确时使用。
仅适用于开发者。
请勿使用。</translation>
    </message>
...
If unsure, do not modify this setting.</source>
      <translation>准确设置 PPU 后端的饱和位（Saturation Bit）值。
如果不确定，请不要修改此设置。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
      <translation>避免破坏 PPU 后端向量操作的非 Java 模式位值。
如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
      <translation>精确设置 PPU 后端的向量指令中的 NaN 结果。
如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
      <translation>准确设置 PPU 后端的 FPCC 比特位。
如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
In addition, when combined with Accurate SPU DMA, SPU PUT cache line accesses will be processed atomically.</source>
      <translation>精确处理 PPU DCBZ 指令。
此外，当与精确的 SPU DMA 同时使用时，SPU 对缓存行的访问将被自动处理。</translation>
    </message>
    <message>
...
Severely degrades performance! If unsure, don&apos;t use this option.</source>
      <translation>强制延迟执行任何奇数 MFC 命令，等待至少 2 个待处理命令后，以随机顺序执行。
必须与当前的 SPU 解释器一起使用。
严重降低性能！如果不确定，请勿使用此选项。</translation>
    </message>
    <message>
      ...
      <translation>允许挂钩（hook）某些函数（如“memcpy”），并将其替换为高级实现。可能无效，也可能导致故障。属实验性功能。</translation>
    </message>
    <message>
...
If unsure, don&apos;t use this option.</source>
      <translation>启用经典 OpenGL 缓冲区，使捕获工具（如 RenderDoc）能够与 RPCS3 配合使用。
同时允许 Vulkan 使用调试标记，以生成更清晰的 RenderDoc 捕获结果。
...
Only useful to developers.
If unsure, don&apos;t use this option.</source>
      <translation>启用所选 API 内置的调试功能。
会导致性能严重下降，尤其在使用 Vulkan 时。
仅适用于开发者。
如果不确定，请勿使用此选项。</translation>
    </message>
    <message>
...
If unsure, don&apos;t use this option.</source>
      <translation>为玩家 1 提供一个带有摇杆输入值的图形叠加层。
此功能仅在“调试叠加层”禁用时显示。
如果不确定，请勿使用此选项。</translation>
    </message>
    <message>
...
If unsure, don&apos;t use this option.</source>
      <translation>将游戏着色器输出到文件中。仅对开发者有用。
如果不确定，请勿使用此选项。</translation>
    </message>
    <message>
...
Might introduce issues with broken occlusion e.g missing geometry and extreme pop-in.</source>
      <translation>禁用运行遮挡查询。可以提升轻微到中等性能。
可能会引入遮挡问题，例如缺失几何形状和极端场景闪烁现象。</translation>
    </message>
    <message>
...
此选项唯一的使用场景是在开发过程中评估 CELL 上的性能。</translation>
    </message>
    <message>
...
This setting overrides the &apos;GPU texture scaling&apos; option.</source>
      <translation>强制在 CPU 上模拟所有的位块传输（blit）的模拟和图像处理操作。
在大多数情况下，还需要启用“写入颜色缓冲区”（Write Color Buffers）选项以避免图形缺失。
会显著降低性能，但在某些情况下更准确。
此设置会覆盖“GPU 纹理缩放”（GPU texture scaling）选项。</translation>
    </message>
    <message>
      ...
      <translation>禁用自定义的 Vulkan 内存分配器，改回直接调用 VkAllocateMemory/VkFreeMemory。</translation>
    </message>
    <message>
      ...
      <translation>完全禁用 RSX FIFO 优化。绘制命令将按照 DMA 拉取器接收到的顺序进行处理。</translation>
    </message>
    <message>
...
May cause texture corruption in some cases.</source>
      <translation>强制在 GPU 上执行所有纹理传输、缩放和转换操作。
在某些情况下可能会导致纹理损坏。</translation>
    ...
    <message>
      ...
      <translation>强制执行纹理刷新，即使在无需或不应刷新的情况下也是如此。已知会导致画面异常，但有助于调试某些纹理缓存问题。</translation>
    </message>
    <message>
...
Over-Under is closer to the native stereo output, but less commonly supported.</source>
      <translation>设置 3D 立体渲染模式（仅在自定义配置且默认分辨率为 720p 时可用）。
红蓝立体（Anaglyph）：为左右眼使用不同颜色，需配合专用滤光眼镜观看。
左右格式（Side-by-Side）：更常被 VR 查看器应用所支持。
上下格式（Over-Under）：更接近原生立体输出格式，但支持较少。</translation>
    </message>
    <message>
...
Numerical values control whether or not to enable the accurate version based on the atomic operation&apos;s length.</source>
      <translation>启用后，PPU 原子操作将对整个高速缓存行数据进行操作，禁用时，则仅对单个 64 位内存块进行操作。
数值根据原子操作的长度来控制是否启用精确版本。</translation>
    </message>
    <message>
      ...
      <translation>模拟器停止后，统计指定事件并生成图表。如果没有被要求，请勿启用。</translation>
    </message>
    <message>
...
2 is the default, if unsure do not modify this setting.</source>
      <translation>影响同时运行的 PPU 线程最大数量，设为 1 时与游戏的兼容性极低。
默认值为 2，如果不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
This is a series of CPU and GPU optimizations and can potentially benefit game performance on some systems.</source>
      <translation>启用 Feral Interactive 的 GameMode。
这是一系列 CPU 与 GPU 的优化措施，在某些系统上可潜在地提升游戏性能。</translation>
    </message>
    <message>
...
To install GameMode for your specific Linux distribution, go to the GitHub page:https://github.com/FeralInteractive/gamemode.</source>
      <translation>这需要已安装 Feral Interactive 的 GameMode。
GameMode 是一系列 CPU 与 GPU 的优化措施，在某些系统上可潜在地提升游戏性能。
要为您的特定 Linux 发行版安装 GameMode，请访问 GitHub 页面：https://github.com/FeralInteractive/gamemode。</translation>
    </message>
    <message>
      ...
      <translation>关闭游戏或当游戏自己关闭时，自动关闭 RPCS3。</translation>
    </message>
    <message>
...
Although it currently also pauses gameplay, it is not recommended to rely on it as this behavior may be changed in the future and it is not the purpose of this setting.</source>
      <translation>当 RPCS3 失去焦点或应用程序处于不活跃状态时，自动暂停模拟，以节省电量并降低 CPU 使用率。
请注意，模拟暂停功能总体上并不完美，可能无法与所有游戏都兼容。
尽管它目前也会暂停游戏进程，但不建议依赖此行为，因为该行为将来可能会更改，而且，这也不是此设置的设计目的。</translation>
    </message>
    <message>
...
Double click on the game window or press Alt+Enter to toggle fullscreen and windowed mode.</source>
      <translation>自动将游戏窗口设置为全屏模式。
双击游戏窗口或按下 Alt+Enter 键在全屏和窗口模式之间切换。</translation>
    </message>
    <message>
...
This option will be disabled if the current platform does not support display sleep control.</source>
      <translation>防止在运行游戏时显示屏进入休眠状态。
在 Linux 系统上需要启用 org.freedesktop.ScreenSaver D-Bus 服务。如果当前平台不支持显示睡眠控制，则此选项将被禁用。</translation>
    </message>
    <message>
...
Changing this and/or adding the framerate may cause buggy or outdated recording software to not notice RPCS3.</source>
      <translation>设置游戏窗口标题。
更改此设置或添加帧率，可能会导致错误或使过时的录制软件无法发现 RPCS3。</translation>
    </message>
    <message>
...
Check this if you want to play with mouse and keyboard (for example with UCR).</source>
      <translation>禁用在游戏画面处于活动状态时通过双击激活全屏模式的功能。
如果你打算使用鼠标和键盘进行游戏（例如配合 UCR），请勾选此项。</translation>
    </message>
    <message>
...
Check this if you want to play with mouse and keyboard.</source>
      <translation>在游戏屏幕处于活跃状态时，禁用键盘快捷键，如 Ctrl+S、Ctrl+E、Ctrl+R、Ctrl+P。
此设置不包括 Ctrl+L（隐藏并锁定鼠标）和 Alt+Enter（切换全屏）。
如果你打算使用鼠标和键盘进行游戏，请勾选此项。</translation>
    </message>
    <message>
...
The default uses all available threads.</source>
      <translation>限制用于初始 PPU 和 SPU 模块编译的最大线程数。
降低此值可提升其他已打开应用程序的性能。
默认使用所有可用线程。</translation>
    </message>
    <message>
...
Currently this may not work every time.</source>
      <translation>当全屏模式激活时显示鼠标光标。
目前此功能可能并非每次都能生效。</translation>
    </message>
    <message>
      ...
      <translation>当全屏模式激活时，将鼠标光标锁定在中心位置。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>使用原生叠加层显示“压力感应强度切换”提示。</translation>
    </message>
    <message>
      ...
      <translation>使用原生叠加层显示“模拟输入限制器切换”提示。</translation>
    </message>
    <message>
      ...
      <translation>显示鼠标和键盘切换提示，使用原生覆盖层。</translation>
    </message>
    <message>
      ...
      <translation>使用原生叠加层显示截图和录制提示。</translation>
    </message>
    <message>
...
Currently, the on-screen keyboard only supports the English key layout.</source>
      <translation>启用游戏窗口内的原生 HUD，该 HUD 可与游戏控制器交互。
禁用时，将改用常规的 Qt 对话框。
目前，屏幕键盘仅支持英文键位布局。</translation>
    </message>
    <message>
...
This also affects screenshots.</source>
      <translation>启用录制时保留叠加层功能。
此设置同样影响截图操作。</translation>
    </message>
    <message>
...
在这种情况下，每当主页菜单打开时暂停模拟可能会有所帮助。</translation>
    ...
    <message>
      ...
      <translation>设置帧率曲线中使用的数据点数量。</translation>
    </message>
    <message>
      ...
      <translation>设置帧时间曲线中使用的数据点数量。</translation>
    </message>
    <message>
      ...
      <translation>设置性能叠加层的屏上（on-screen）位置（象限）。</translation>
    </message>
    <message>
      ...
      <translation>控制性能叠加层中显示的信息数量。</translation>
    </message>
    <message>
...
The performance overlay refresh rate does not affect the frame graph statistics and can only be as fast as the current game allows.</source>
      <translation>设置性能叠加层的刷新时间间隔 (以毫秒为单位)。
刷新时间间隔设置为 16 ms时，叠加图层将以约 60Hz 刷新。
叠加图层的刷新率不会影响帧速率图的统计。图层刷新率最高只能与当前游戏所允许的速度一样。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>设置水平距离到屏幕边界相对于屏幕象限的值 (以像素为单位)。</translation>
    </message>
    <message>
      ...
      <translation>设置垂直距离到屏幕边界相对于屏幕象限的值 (以像素为单位)。</translation>
    </message>
    <message>
      ...
      <translation>将性能叠加层水平居中，并覆盖水平边距。</translation>
    </message>
    <message>
      ...
      <translation>将性能叠加层垂直居中，并覆盖垂直边距。</translation>
    </message>
    <message>
...
By default the used image will be &lt;gamedir&gt;/PS3_GAME/PIC1.PNG.</source>
      <translation>显示原生着色器加载对话框/加载屏幕时的背景图像。
默认使用的图像路径为 &lt;gamedir&gt;/PS3_GAME/PIC1.PNG。</translation>
    </message>
    <message>
...
This may be used to improve readability and/or aesthetics.</source>
      <translation>更改本机着色器加载期间显示的背景图片的暗化效果强度。
此选项用来改善文字可读性或界面美观度。</translation>
    </message>
    <message>
...
This may be used to improve readability and/or aesthetics.</source>
      <translation>更改原生着色器加载对话框的背景图像的模糊效果强度。
此选项用来改善文字可读性或界面美观度。</translation>
    </message>
    <message>
...
If unsure, use Vulkan. Should you have any compatibility issues, fall back to OpenGL.</source>
      <translation>Vulkan是最快的渲染器，OpenGL是最精确的渲染器。
如果不确定，使用Vulkan。如有兼容性问题，请切换至OpenGL。</translation>
    </message>
    <message>
...
Rarely due to emulation bugs some games will only render at low resolutions like 480p.</source>
      <translation>如果“分辨率缩放”设置为 100% 以外的任何值，都将忽略此设置!
请将此选项保持在“1280x720”，每个 PS3 游戏都与该分辨率兼容，
仅在游戏支持的情况下，才能使用“1920x1080”。
少数情况下，由于模拟器出错，一些游戏只能在低分辨率 (480p) 下渲染。</translation>
    </message>
    <message>
...
This is not needed when using OpenGL.</source>
      <translation>在多GPU系统中，当使用Vulkan时，在RPCS3中选择要使用的GPU。
这在使用OpenGL时不需要。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="184"/>
      <source>Leave this on 16:9 unless you have a 4:3 monitor.</source>
      <translation>除非你有4:3的显示器，否则请将设置保持为16:9。</translation>
    </message>
    <message>
...
Experienced users with need of other frame limits should use the setting &quot;Second Frame Limit&quot; in the configuration file.</source>
      <translation>「关闭」是最快的选项。
使用帧限制器会增加额外开销并降低游戏性能。然而，某些游戏如果帧率过高可能会崩溃。
「PS3 原生」仅在“自动”功能不正常时使用，因为它可能引入帧同步问题。
「无限制」添加了一个正反馈循环，每帧增加一个垂直空白信号，允许更多游戏突破帧率限制。
需要自定义其他帧率限制的专业用户，可以在配置文件中启用二级帧率限制设置。</translation>
    </message>
    <message>
...
Low to moderate performance hit depending on your GPU hardware.</source>
      <translation>模拟PS3的多采样布局。
可以解决一些难以解决的图形错误。
对性能有低到中等程度的影响，具体取决于您的 GPU 。</translation>
    </message>
    <message>
...
Keep this on Automatic if you want to use the original setting used by a real PS3.</source>
      <translation>较高的值可以增加斜面纹理的清晰度，但会消耗 GPU 资源。
不过即使选择“16x”，目前主流的 GPU 都能很好地处理此设置。
如果要使用真实 PS3 的原生设置，请将此项保持在“自动”。</translation>
    </message>
    <message>
...
基础分辨率始终为 1280x720。
如果要使用标准的分辨率选项，请将此值设置为 100%。
数值低于 100% 通常不会提高性能。</translation>
    </message>
    <message>
...
If unsure, don&apos;t change this option.</source>
      <translation>只有大于此尺寸的帧缓冲才会进行放大。
增加这个值可能会解决在放大时出现的缺失图形的问题，特别是当“写入颜色缓冲区”启用时。
如果不确定，不要更改此选项。</translation>
    </message>
    <message>
...
Required for Demon&apos;s Souls.</source>
      <translation>如果游戏中出现图形缺失或照明损坏，请开启此选项。
某些情况下可能会降低性能或导致卡顿。
运行《恶魔之魂》需要开启此项。</translation>
    </message>
    <message>
      ...
      <translation>关闭此选项。以可能会出现画面撕裂的为代价。获得更高的帧率。</translation>
    </message>
    <message>
...
If unsure, don&apos;t use this option.</source>
      <translation>强制遵循 API 规范。
可能在一些游戏中导致性能下降。
能够解决罕见的图形缺失和闪烁问题。
如果不确定，请不要使用此选项。</translation>
    </message>
    <message>
      ...
      <translation>覆盖“宽高比”选项，并将图像拉伸到整个显示区域。</translation>
    </message>
    <message>
...
May cause slowdown in weaker CPUs due to the extra worker thread load.</source>
      <translation>将部分RSX操作分流到辅助线程。
提升多核处理器的性能。
由于额外的工作线程负载，可能会导致性能较弱的CPU运行速度下降。</translation>
    </message>
    <message>
...
此功能可修复着色器编译时出现的图形缺失问题，但会导致严重的卡顿或延迟。
如果您不想遇到图形突然弹出的情况，或者在提交任何错误报告前进行测试，请使用此功能。</translation>
    </message>
    <message>
...
You may experience graphics pop-in.</source>
      <translation>这是推荐选项。
如果在缓存中未找到着色器，那么在该着色器编译完成前，不会为其渲染任何内容。
您可能会遇到图形突然出现的情况。</translation>
    </message>
    <message>
...
If a shader is not found in the cache, the interpreter will be used to render approximated graphics for this shader until it has compiled.</source>
      <translation>混合渲染模式。
如果在缓存中未找到着色器，解释器将被用来为该着色器渲染近似图形，直到该着色器编译完成。</translation>
    </message>
    <message>
...
This mode is very slow and experimental.</source>
      <translation>所有渲染都由解释器处理，不尝试编译原生着色器。
此模式速度很慢且处于试验阶段。</translation>
    </message>
    <message>
...
仅在着色器模式设置为异步渲染、混合渲染时才起作用。</translation>
    </message>
    <message>
      ...
      <translation>设置生成着色器的精确度级别。
低精度会根据硬件使用生成速度更快的代码，但有时会产生轻微的视觉故障或闪烁。</translation>
    </message>
    <message>
...
Only works with Vulkan renderer and greatly benefits from having MTRSX enabled if you have a capable CPU.</source>
      <translation>利用异步计算，在进行 3D 渲染的同时将纹理流式传输到 GPU 处理。
在高性能的 GPU 上可以进一步提升性能，需要 GPU 有性能冗余。
仅适用于 Vulkan 渲染模式，如果您有一个高性能的 CPU，则开启 MTRSX 将大有帮助。</translation>
    </message>
    <message>
...
Using Prefer borderless fullscreen option can help if you have issues with streaming RPCS3 gameplay or if your system incorrectly enables HDR mode when using fullscreen.</source>
      <translation>控制模拟器在使用 Vulkan 渲染模式时需要从驱动程序请求哪种全屏模式。
“自动”将允许驱动程序选择适当的模式，而其他选项将提示驱动程序是应使用独占全屏还是无边框全屏。
如果在串流输出游戏时遇到问题，或者系统在使用全屏时错误地启用了 HDR 模式，则选择“无边框全屏”选项会有所帮助。</translation>
    </message>
    <message>
...
FidelityFX does not work with stereo 3D output for now.</source>
      <translation>应用在最终图像上的滤镜。
“临近取样”输出锯齿感更强的图像，“双线性过滤”输出更加平滑的图像，“FSR 1.0”输出空间超分的图像。
如果游戏以低于显示分辨率的内部分辨率渲染，FidelityFX 超分辨率锐画技术 (FSR) 会将图像增强至显示器原始分辨率。
开启 FSR 可能会导致视觉瑕疵。目前，FidelityFX 无法与立体 3D 输出配合使用。</translation>
    </message>
    <message>
      ...
      <translation>设置使用 FidelityFX 超分辨率锐画技术时图像的锐化强度。较高的值将提供更清晰的输出，但可能导致伪影。</translation>
    </message>
    <message>
...
-3 to +3 is plenty for most usecases</source>
      <translation>调整纹理采样精度。 (一个小更改就会产生巨大影响。)
如果不确定，请不要使用 -12 到 +12 范围之外的值。
大多数情况下 -3 到 +3 已经足够了。</translation>
    </message>
    <message>
...
Set 0 in order to remove the limit.</source>
      <translation>设置 LOG 可以显示的最大块数。
这通常等于行数。
设置 0 以删除限制。</translation>
    </message>
    <message>
...
选择一个“风格”并点击“应用”，可以在风格之间切换。</translation>
    ...
    <message>
      ...
      <translation>游戏窗口关闭时，展示一个确认对话框。</translation>
    </message>
    <message>
      ...
      <translation>当启动一个游戏时，若已有其他游戏正在运行，则展示一个确认对话框。</translation>
    </message>
    <message>
      ...
      <translation>软件包（pkg）安装成功时，展示一个对话框。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>发现过时的设置项时，展示一个对话框。</translation>
    </message>
    <message>
      ...
      <translation>在游戏手柄配置中，当同一个按键被分配了两次时，展示一个对话框。</translation>
    </message>
    <message>
      ...
      <translation>RPCS3 更新完成后准备重启时，展示一个对话框。</translation>
    </message>
    <message>
...
If &quot;Background&quot; is selected, the check is done silently in the background and a new download option is shown in the top right corner of the menu if a new version was found.</source>
      <translation>启动时检查是否有可用更新，并询问您是否要更新。
如果选择“自动”，更新将无需用户确认而自动执行。
如果选择“后台”，检查将在后台静默进行；若发现新版本，菜单右上角将显示新的下载选项。</translation>
    </message>
    <message>
...
Requires a restart of RPCS3 to completely close the connection.</source>
      <translation>启用 Discord Rich Presence 功能，以在 Discord 上显示你正在游玩的游戏。
需要重启 RPCS3 才能完全关闭连接。</translation>
    ...
    <message>
      ...
      <translation>告诉你的好友你正在做什么（在玩什么游戏）。</translation>
    </message>
    <message>
      ...
      <translation>优先使用自定义的用户界面颜色，而非样式表中设置的属性。</translation>
    </message>
    <message>
...
仅当你更改了硬件配置，或将 RPCS3 复制到另一台 PC 时，才应重置此 ID。</translation>
    </message>
    <message>
      ...
      <translation>使用为玩家 1 配置的游戏手柄来进行界面（GUI）导航。</translation>
    </message>
    <message>
      ...
      <translation>即使 RPCS3 不是活跃窗口，也保持手柄对导航的控制。</translation>
    </message>
    <message>
...
Only use multi-threaded if you can spare the extra threads.</source>
      <translation>单线程：所有手柄处理程序在同一线程中依次运行。
多线程：每个手柄处理程序都拥有其自己的线程。
仅当你有富余的线程资源时，才应使用多线程模式。</translation>
    </message>
    <message>
      ...
      <translation>始终在游戏中显示所有配置的手柄为已连接状态，即使实际上它们已断开连接。</translation>
    </message>
    <message>
...
Basic will work in these cases.</source>
      <translation>部分游戏支持原生键盘输入。
在此类情况下，“基础”（Basic）模式即可正常工作。</translation>
    </message>
    <message>
...
Basic or Raw will work in these cases.</source>
      <translation>部分游戏支持原生鼠标输入。 
在此类情况下，“基础”（Basic）或“原始”（Raw）模式均可正常工作。</translation>
    </message>
    <message>
...
选择 Qt 会使用操作系统的默认音频输出设备。 
该选项可能无法播放所有音频格式。</translation>
    </message>
    <message>
      ...
      <translation>选择 Qt Camera 会使用操作系统的默认摄像头设备。</translation>
    </message>
    <message>
      ...
      <translation>根据游戏的不同，你可能需要选择特定的摄像头类型。</translation>
    </message>
    <message>
...
模拟（Fake）：实验性功能！将 Move 控制映射到 DS3 控制器的按键布局。 
鼠标（Mouse）：使用鼠标处理程序模拟 PSMove。 
原始鼠标（Raw Mouse）：使用原始鼠标处理程序模拟 PSMove。</translation>
    </message>
    <message>
...
Select Null if the game has support for DualShock or if you have real Buzz! controllers.</source>
      <translation>Buzz! 支持。 
如果游戏需要 Buzz! 控制器而你没有实体控制器，请选择 1 个或 2 个控制器。 
如果游戏支持 DualShock 控制器，或你拥有实体 Buzz! 控制器，请选择“无”（Null）。</translation>
    </message>
    <message>
...
如果游戏需要 DJ Hero 转盘控制器而你没有实体转盘控制器，请选择 1 个或 2 个控制器。
如果游戏支持 DualShock 控制器，或你拥有实体转盘控制器，请选择“无”（Null）。
实体转盘控制器可与模拟的转盘控制器同时使用。</translation>
    </message>
    <message>
...
如果游戏需要 GHL 吉他控制器而你没有实体吉他控制器，请选择 1 个或 2 个控制器。
如果游戏支持 DualShock 控制器，或你拥有实体吉他控制器，请选择“无”（Null）。
实体吉他控制器可与模拟的吉他控制器同时使用。</translation>
    </message>
    <message>
      ...
      <translation>允许在游戏窗口失去焦点的情况下进行手柄和键盘输入。</translation>
    </message>
    <message>
...
这在校准屏幕时非常有用。</translation>
    ...
    <message>
      ...
      <translation>加载 SDL GameController 数据库以提升游戏手柄兼容性。仅在 SDL 手柄处理程序中使用。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="252"/>
      <source>Locks the native overlay input to the first player.</source>
      <translation>将原生输入显示锁定到第一个玩家上。</translation>
    </message>
    <message>
      ...
      <translation>如果设置为已连接（Connected），RPCS3 将允许程序使用你的互联网连接。</translation>
    </message>
    <message>
...
Simulated is only available in custom configurations.</source>
      <translation>如果设置为 RPCN，RPCS3 将在游戏受支持的情况下使用 RPCN 服务器作为 PSN 连接。
如果设置为模拟（Simulated），RPCS3 将尝试模拟 PSN 连接，但任何实际使用 PSN 功能的尝试都可能导致错误或崩溃。
模拟（Simulated）仅在自定义配置中可用。</translation>
    </message>
    <message>
...
Only affects games supporting the Clans feature.</source>
      <translation>启用连接至 Clans 服务器。
仅影响支持 Clans 功能的游戏。</translation>
    </message>
    <message>
...
Depending on the license area, some games may not work.</source>
      <translation>主机区域定义了 PS3 的授权区域。
根据授权区域的不同，有些游戏可能无法运行。</translation>
    </message>
    <message>
...
Currently only US, Japanese and German layouts are fully supported at this moment.</source>
      <translation>设置所使用的键盘布局。
目前仅美式（US）、日语和德语布局在当前得到完整支持。</translation>
    </message>
    <message>
...
In these cases having the cross button assigned can often lead to confusion.</source>
      <translation>用于系统对话框中“进入/接受/确认”的按键。
可将其更改为圆圈键，这是日版系统及许多日版游戏的默认设置。
在这些情况下，若仍将叉键设为确认键，常常会引起混淆。</translation>
    </message>
    <message>
...
If unsure, do not use this option.</source>
      <translation>某些自制软件（Homebrew）所需。
如果不确定，请勿使用此选项。</translation>
    </message>
    <message>
...
If unsure, do not use this option</source>
      <translation>某些自制软件（Homebrew）或游戏模组（Game Mods）所需。
如果不确定，请勿使用此选项</translation>
    </message>
    <message>
...
This setting is only available in the global configuration.</source>
      <translation>启动时，如果磁盘缓存大小超过指定值，将自动删除其中较旧的文件。
游戏可使用缓存文件夹在系统内存之外临时存储数据，但该缓存不用于长期存储。
...
Can be reset to current wall clock time by clicking &quot;Set to Now&quot;.</source>
      <translation>设置主机内部使用的时间。该时间将以偏移量的形式应用，并跟随系统当前的实际时间（墙上时钟）同步。
点击“设为当前时间”（Set to Now）可将其重置为系统当前的实际时间；。</translation>
    </message>
    <message>
      ...
      <translation>此控制器已被禁用，软件中会显示它未连接。请选择另一个控制器以启用它。</translation>
    </message>
    <message>
      ...
      <translation>这个端口当前被应用分配给了自定义控制器，无法更改。</translation>
    </message>
    <message>
      ...
      <translation>虽然可以在 RPCS3 中使用键盘模拟手柄，但强烈建议使用实体控制器。&lt;br&gt;若要将鼠标移动绑定到某个按键或摇杆，请先点击目标按键以激活绑定，然后按住鼠标并朝所需方向拖动。</translation>
    </message>
    <message>
      ...
      <translation>要使用 DualShock 3 处理程序，你首先需要安装官方的 DualShock 3 驱动程序。&lt;br&gt;请参阅&lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt;以获取说明。</translation>
    </message>
    <message>
      ...
      <translation>要使用 DualShock 3 处理程序，你可能需要添加 udev 规则来允许 RPCS3 访问该设备。&lt;br&gt;可以查看&lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt;中的指南以进行操作。</translation>
    </message>
    <message>
      ...
      <translation>对于官方的 DualShock 3 控制器，推荐使用 DualShock 3 处理程序。</translation>
    </message>
    <message>
      ...
      <translation>如果你在使用 DualShock 4 处理程序时遇到任何问题，可能是因为第三方工具如 DS4Windows 导致的。建议在使用此处理程序时禁用这些工具。</translation>
    </message>
    <message>
      ...
      <translation>要使用 DualShock 4 处理程序，你可能需要添加 udev 规则来允许 RPCS3 访问该设备。&lt;br&gt;可以查看&lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt;中的指南以进行操作。</translation>
    </message>
    <message>
      ...
      <translation>对于官方的 DualShock 4 控制器，推荐使用 DualShock 4 处理程序。</translation>
    </message>
    <message>
      ...
      <translation>对于官方的 DualSense 控制器，推荐使用 DualSense 处理程序。</translation>
    </message>
    <message>
      ...
      <translation>对于官方的 RIDE 滑板（skateboard）控制器，推荐使用 Skateboard 处理程序。</translation>
    </message>
    <message>
      ...
      <translation>对于官方的 PS 体感控制器，推荐使用 PS Move 处理程序。</translation>
    </message>
    <message>
      ...
      <translation>XInput 处理程序适用于 Xbox 控制器以及兼容 PC 的第三方控制器。当把 SCP 的 XInput1_3.dll 放在 RPCS3 的主目录中时，就可支持 SCP 的压力感应按键。更多详细信息，请参阅&lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt;。</translation>
    </message>
    <message>
      ...
      <translation>evdev 处理程序能与任何支持 Linux 的控制器一起使用。如果你的手柄无法正确居中，请参阅&lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt;以获取说明。</translation>
    </message>
    <message>
      ...
      <translation>MMJoystick控制器能够与几乎所有Windows可识别的控制器兼容。然而，如果你的控制器支持其它的控制器程序，推荐你使用其它具体的处理程序。</translation>
    </message>
    <message>
      ...
      <translation>SDL控制器支持在不同平台上的各种控制器。</translation>
    </message>
    <message>
      ...
      <translation>按下时重置传感器方向。&lt;br&gt;切换复选框以启用或禁用方向功能。&lt;br&gt;目前仅用于 PS Move 交互。</translation>
    </message>
    <message>
      ...
      <translation>按下此特殊按钮时应用摇杆倍增器。&lt;br&gt;如果需要通过按钮按压切换模拟限制器，请启用“切换”选项。&lt;br&gt;如果未分配任何按钮，摇杆倍增器将始终生效。</translation>
    </message>
    <message>
      ...
      <translation>此选项控制按下特殊按钮时触发压感按钮的强度。&lt;br&gt;如果想在按压按钮时切换强度，请启用“切换”选项。&lt;br&gt;使用百分比来调整想要按压按钮的力度。</translation>
    </message>
    <message>
      ...
      <translation>设置压感按钮的触发值，这决定了被游戏识别到所需的最小按压力度。输出范围将被映射到所有按钮的灵敏度范围上。</translation>
    </message>
    <message>
      ...
      <translation>DualShock 3 摇杆的实际活动范围并非圆形，而是类似圆角正方形（即“方圆形”），这代表了模拟摇杆的最大输入范围。如果摇杆无法触及该范围的角落，可使用方圆度（squircle）值调整输入。设为 0 表示不应用任何方圆化处理，通常建议值为 8000。</translation>
    </message>
    <message>
      ...
      <translation>摇杆灵敏度可以用来调整摇杆动作的灵敏度。&lt;br&gt;默认设置为 1，表示正常输入。</translation>
    </message>
    <message>
      ...
      <translation>摇杆的死区决定了摇杆需要移动多远才会被游戏完全识别。该范围之后会被映射到完整的输入范围内，以提供平滑的操作体验。死区内的微小移动会通过“反死区”滑块（默认为 13%）进行模拟，因此即使在模拟摇杆预览中仍看到移动，也无需担心。</translation>
    </message>
    <message>
      ...
      <translation>PS3 通过两个马达（大马达和小马达）来实现手柄震动。&lt;br&gt;你可以在此处为当前选中的手柄启用、禁用，甚至交换这两个马达的信号。&lt;br&gt;游戏会发送 0–255 的数值来控制马达震动强度。&lt;br&gt;任何小于或等于阈值的数值将被设为 0。&lt;br&gt;对于非 DualShock 3 手柄的控制器驱动，默认阈值为 63，以模拟 DualShock 3 的震动行为。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/tooltips.h" line="308"/>
      <source>Use this to configure the gamepad motion controls.</source>
      <translation>此选项用来配置游戏手柄的运动控制。</translation>
    </message>
    <message>
      ...
      <translation>摇杆预览中的模拟摇杆值（红点）表示游戏实际接收到的摇杆位置。DualShock 3 摇杆的真实活动范围并非圆形，而是类似圆角正方形（或方圆形），这代表了模拟摇杆的最大输入范围。蓝色的普通点表示转换为游戏输入前的原始摇杆值（包含摇杆倍率）。</translation>
    </message>
    <message>
      ...
      <translation>扳机的死区决定了扳机需要按下多深才会被游戏识别。该有效范围会被映射到完整的输入区间，以提供平滑的操作体验。</translation>
    </message>
    <message>
      ...
      <translation>使用键盘，你不可避免地会被限制在8个摇杆方向（4个直线+4个对角线）。
此外，当按下一个键时，摇杆会立即跳到所选方向的最大值。
摇杆插值可以通过平滑这些方向变化来解决这两个问题。值越低，你按下或释放键的时间就越长，直到达到最大幅度。</translation>
    </message>
    <message>
      ...
      <translation>鼠标死区表示游戏自身在 X 轴和 Y 轴上设置的死区。游戏通常会设置自己的死区，以过滤摇杆的微小非预期移动。因此，使用鼠标输入时会感觉不够直观，因为鼠标依赖即时响应。你可以在游戏过程中临时调整这些值，以找到最适合当前游戏的设置（Alt+T / Alt+Y 调整 X 轴，Alt+U / Alt+I 调整 Y 轴）。</translation>
    </message>
    <message>
      ...
      <translation>鼠标加速可以用来放大你在x轴和y轴上的鼠标移动。如果你在玩游戏时觉得鼠标移动速度过慢，可以增加这些值。
你可以在游戏过程中暂时更改这些值来找到最合适的值 (按Alt+G和Alt+H改变X轴的值，按Alt+J和Alt+K改变Y轴的值)。
请注意，现代鼠标通常提供独立的模式和设置，可以用来改变鼠标移动速度。</translation>
    </message>
    <message>
      ...
      <translation>鼠标移动模式决定鼠标动作如何转换为手柄输入。&lt;br&gt;使用相对模式可获得传统鼠标移动效果。&lt;br&gt;使用绝对模式则以鼠标到屏幕中心的距离作为输入值。</translation>
    </message>
    <message>
      ...
      <translation>左键单击：重新映射此按钮。&lt;br&gt;Shift + 左键单击：添加额外的按钮映射。&lt;br&gt;Alt + 左键单击：区分扳机按下与释放（目前仅限 XInput）。&lt;br&gt;右键单击：清除此按钮映射。</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>RPCS3 PlayStation 3模拟器</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>GitHub 链接</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Patreon（捐赠）</translation>
    </message>
    <message>
...
There are still plenty of implementations to make and optimizations to do.</source>
      <translation>RPCS3 是一款开源的索尼 PlayStation 3 模拟器和调试器。
程序使用 C++ 编写，适用于 Windows、Linux、FreeBSD 和 MacOS 系统，由 %0 资助。
我们的开发人员和贡献者始终在努力工作，以确保这个项目尽可能做到最好。
目前仍有大量功能需要实现，还有许多优化工作有待完成。</translation>
    </message>
  </context>
  <context>
...
Restart of the game is required to apply. You can enable/disable this in the settings.</source>
      <translation>要使用自动暂停功能：输入一个函数的ID或系统调用的ID。
需要重新启动游戏才能应用。您可以在设置中启用/禁用此功能。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>自动暂停管理器</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>默认输入鼠标控制器设置</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>仅解释器模式！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/breakpoint_list.cpp" line="129"/>
      <source>Cannot set breakpoints on non-interpreter decoders.</source>
      <translation>无法在非解释器解码器上设置断点。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>禁用 BPM</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/breakpoint_list.cpp" line="244"/>
      <source>Enable BPM</source>
      <translation>启用 BPM</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>未找到处理程序</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>RPCS3 没有权限访问此设备的摄像头。</translation>
    </message>
    <message>
      ...
      <translation>摄像头不可用</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/camera_settings_dialog.cpp" line="364"/>
      <location filename="./rpcs3/rpcs3qt/camera_settings_dialog.cpp" line="451"/>
...
It might be blocked by another application.</source>
      <translation>所选摄像头不可用。
它可能被其他应用程序阻止了。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>%0x%1, %2 FPS, 格式t=%3</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>选择 Cg 目标程序</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/cg_disasm_window.cpp" line="80"/>
      <source>Cg program objects (*.fpo;*.vpo);;</source>
      <translation>Cg 目标程序 (*.fpo;*.vpo);;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>无法将输入的搜索值转换为选定的整数类型。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>显示的条目过多 (%0)</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>公会: 添加服务器</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>主机名缺失！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/clans_settings_dialog.cpp" line="174"/>
      <source>You must enter a hostname for the server!</source>
      <translation>你必须为服务器输入一个主机名！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>此服务器无法删除。</translation>
    </message>
  </context>
  <context>
...
某些设置似乎偏离了默认配置：</translation>
    ...
    <message>
      ...
      <translation>未找不到任何配置！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>添加断点错误</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/debugger_add_bp_window.cpp" line="67"/>
  ...
  <context>
    ...
    <message>
      ...
      <translation>调试器 [按 F1 获取帮助]</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>行至断点时暂停所有线程</translation>
    </message>
    <message>
...
Applies on all breakpoints in all threads regardless if set before or after changing this setting.</source>
      <translation>设置后：行至断点时，将暂停模拟操作而不是暂停当前线程。
此设置适用于所有线程中的所有断点，无论是在更改此设置之前还是之后。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>调试器指南与快捷键</translation>
    </message>
    <message>
...
Double-click: Set breakpoints.</source>
      <translation>Keys Ctrl+G: 跳转至输入的地址。
Keys Ctrl+B: 打开断点设置。
Keys Ctrl+C: 复制指令内容。
Keys Ctrl+F: 查找线程。
Keys Alt+S: 从PPU调用时捕获选定SPU或通用形式的SPU图像。
Keys Alt+S: 从RSX调用时打开指向当前RSX信号量位置的内存查看器。
Keys Alt+R: 加载最后保存的SPU状态捕获。
Keys Alt+F5: 显示SPU反汇编器对话框。
Key D: SPU MFC命令日志记录器，需启用MFC调试设置。
Key D: 同时记录PPU调用历史，需使用解释器和非零调用历史大小。
Key E: 指令编辑器：点击要修改的指令，然后按E。
Key F: SPU线程专用浮点模式切换。
Key R: 所选线程的寄存器编辑器。
Key N: 显示线程执行标记指令后的下一条指令，若目标不可预测则无操作。
Key M: 打开内存查看器，初始地址指向标记指令。
Key I: 显示RSX方法详情。
Key F10: 执行指令跳过操作。（跳过函数调用）
Key F11: 执行单步指令。
Key F1: 显示此帮助对话框。
Key Up: 向上滚动一条指令。（地址递减）
Key Down: 向下滚动一条指令。（地址递增）
Key Page-Up: 向上滚动，步数等于查看的指令数量。
Key Page-Down: 向下滚动，步数等于查看的指令数量。
双击: 设置断点。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/debugger_frame.cpp" line="497"/>
      <source>Max MFC cmds logged</source>
      <translation>最大 MFC 命令记录数</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/debugger_frame.cpp" line="497"/>
    ...
    <message>
      ...
      <translation>请选择一个十六进制值。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>RSX 命令详细信息</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>可用 Dimensions 角色：</translation>
    </message>
    <message>
...
文件过小。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>PPU 地址：0x00000000，LS 地址：0x00000，段大小：0x00000，Flags：0x0</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/elf_memory_dumping_dialog.cpp" line="54"/>
      <source>Add new segment</source>
      <translation>添加新段落</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
      ...
      <translation>PPU 地址：0x%0，LS 地址：0x%1，段大小：0x%2，Flags：0x%3</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法保存SPU ELF。</translation>
    </message>
  </context>
  <context>
...
错误：%1</translation>
    ...
    <message>
      ...
      <translation>修复无效设置？</translation>
    </message>
    <message>
...
只有在保存配置时，这些更改才会生效。</translation>
    ...
    <message>
      ...
      <comment>Output Scaling Mode</comment>
      <translation>FSR 1.0</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Microphone handler</comment>
      <translation>真实的SingStar</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Move handler</comment>
      <translation>原始鼠标输入</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Audio Avport</comment>
      <translation>AV多路输出</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Audio Channel Layout</comment>
      <translation>立体声LFE</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Audio Channel Layout</comment>
      <translation>四声道 LFE</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>License Area</comment>
      <translation>欧洲, 大洋洲, 中东地区, 俄罗斯</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Keyboard Type</comment>
      <translation>英式键盘 (英国标准)</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>配置 模拟 罗技 G27 双引擎力反馈方向盘</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>警告：该力反馈输出参数是专为罗技 G27 调校的；若使用推力更强的方向盘，请在方向盘专属驱动软件中酌情调低力反馈强度。</translation>
    </message>
    <message>
      ...
      <translation>注意：严禁将方向盘映射到游戏手柄，仅在此处进行方向盘专属映射。
若你已将方向盘映射至手柄，请前往手柄设置界面取消该映射。
若你此前为运行 RPCS3，曾用 vJoy 把方向盘映射成手柄，需将该操作彻底撤销。</translation>
    </message>
    <message>
      ...
      <translation>启用（需要重新启动游戏）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>使用以下力反馈映射的设备：</translation>
    </message>
    <message>
      ...
      <translation>使用以下LED映射的设备：</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>模拟 Top Shot Fearmaster 设置</translation>
    </message>
    <message>
...
当你的设备常规按钮数量不足时，此功能会很有用。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>请勿提交不正确的报告。感谢理解。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>输入的编号无效！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/infinity_dialog.cpp" line="569"/>
      <source>Series number entered is invalid!</source>
      <translation>输入的系列号无效！</translation>
    </message>
    <message>
...
%1</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>可以完美运行，没有破坏性的游戏故障</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法完成游戏，存在严重错误或性能不足。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>游戏不能正确初始化，根本无法加载和/或使模拟器崩溃</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>此游戏或应用目前尚未在兼容性数据库中登记。</translation>
    </message>
    <message>
...
Make sure you are connected to the internet.</source>
      <translation>在此处右键点击，下载当前数据库。
确保已连接至互联网。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/game_compatibility.h" line="133"/>
      <source>Retrieving...</source>
      <translation>正在检索...</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/game_compatibility.h" line="133"/>
...
%0 信息：
    ...
    <message>
      ...
      <translation>%0 个选中游戏：光盘游戏 %1 个，非光盘游戏 %2 个
</translation>
    </message>
    <message>
...
当前可用磁盘空间：%0
    ...
    <message>
      ...
      <translation>无法删除，因为内容位于自动检测的VFS虚拟文件系统“games”文件夹下</translation>
    </message>
    <message>
...
Permanently remove %0 and selected (optional) contents from drive?
      ...
      <translation>
从驱动器永久删除 %0 及所选（可选）内容？</translation>
    </message>
    <message>
 ...
 虚拟文件系统磁盘占用: %0%1</translation>
  ...
  缓存磁盘占用: %0</translation>
    ...
    <message>
      ...
      <translation>正在运行标题 %1 ，不允许删除 %0 ！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/game_list_actions.cpp" line="434"/>
      <location filename="./rpcs3/rpcs3qt/game_list_actions.cpp" line="458"/>
    ...
    <message>
      ...
      <translation>正在运行模拟器，不允许删除 %0 ！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除配置文件失败！</translation>
    </message>
    <message>
...
设置将恢复为全局手柄设置。</translation>
    ...
    <message>
      ...
      <translation>创建 LLVM 缓存？</translation>
    </message>
    <message>
...
进度: %1/%2 缓存已编译</translation>
    ...
    <message>
      ...
      <translation>批量删除自定义设置</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/game_list_actions.cpp" line="1115"/>
    ...
    <message>
      ...
      <translation>创建一个或多个快捷方式失败！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>使用手动选择的设置重新启动(&amp;M)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>从全局设置创建自定义设置(&amp;G)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>&amp;Create LLVM Cache</source>
      <translation>创建LLVM缓存(&amp;V)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>&amp;Remove Custom Configuration</source>
      <translation>删除自定义设置(&amp;C)</translation>
    </message>
    <message>
      ...
      <source>&amp;Remove Custom Gamepad Configuration</source>
      <translation>删除自定义控制器设置(&amp;G)</translation>
    </message>
    <message>
      ...
      <translation>删除着色器缓存(&amp;S)</translation>
    </message>
    <message>
      ...
      <translation>删除PPU缓存(&amp;P)</translation>
    </message>
    <message>
      ...
      <translation>删除SPU缓存(&amp;U)</translation>
    </message>
    <message>
      ...
      <translation>删除HDD1缓存(&amp;H)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>&amp;Remove Savestates</source>
      <translation>删除保存状态(&amp;S)</translation>
    </message>
    <message>
      ...
      <translation>管理游戏(&amp;M)</translation>
    </message>
    <message>
      ...
      <translation>创建桌面快捷方式(&amp;D)</translation>
    </message>
    <message>
      ...
      <translation>创建开始菜单快捷方式(&amp;S)</translation>
    </message>
    <message>
      ...
      <translation>创建启动台快捷方式(&amp;L)</translation>
    </message>
    <message>
      ...
      <translation>创建应用程序菜单快捷方式(&amp;A)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>编辑运行窗口注释(&amp;E)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>更改自定义图标(&amp;R)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择自定义悬浮Gif</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除%0的自定义着色器加载背景？</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除旧文件失败！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/game_list_context_menu.cpp" line="406"/>
    ...
    <message>
      ...
      <translation>复制名称 + 序列号(&amp;C)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>下载兼容性数据库(&amp;D)</translation>
    </message>
    <message>
      ...
      <source>&amp;Disk Usage</source>
      <translation>磁盘占用(&amp;U)</translation>
    </message>
    <message>
      ...
      <source>&amp;Game Info</source>
      <translation>游戏信息(&amp;I)</translation>
    </message>
    <message>
...
%0 [%1]</translation>
    ...
    <message>
      ...
      <translation>删除游戏(&amp;R)</translation>
    </message>
  </context>
  <context>
...
%0</translation>
    ...
    <message>
      ...
      <translation>显示动态控制器</translation>
    </message>
    <message>
...
%%2</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>截图已保存: %0</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>确认要退出游戏吗？&lt;br&gt;&lt;br&gt;所有未保存的进度都将丢失！&lt;br&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>实验性构建警告</translation>
    </message>
    <message>
...
Do you wish to use this build anyway?</source>
      <translation>请注意，此版本不是官方 RPCS3 发行版。 
该版本包含的更改可能导致游戏无法运行，甚至可能&lt;b&gt;损坏&lt;/b&gt;数据。 
我们建议从 %0 下载并使用官方版本。

构建来源：%1
是否仍要使用此版本？</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/gui_application.cpp" line="119"/>
      <source>RPCS3 website</source>
      <translation>RPCS3 网站</translation>
    </message>
    <message>
...
继续等待还是不安全地终止RPCS3，风险自负？</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>关闭正在运行的游戏？</translation>
    </message>
    <message>
      ...
      <translation>此操作将关闭当前运行的游戏。&lt;br&gt;确认继续吗？&lt;br&gt;&lt;br&gt;所有未保存的进度都将丢失！&lt;br&gt;</translation>
    </message>
    <message>
      ...
      <translation>启动另一个游戏将关闭当前运行的游戏。&lt;br&gt;确认要要启动另一个游戏吗？&lt;br&gt;&lt;br&gt;所有未保存的进度都将丢失！&lt;br&gt;</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/gui_settings.cpp" line="222"/>
      <source>Exit RPCS3?</source>
      <translation>退出RPCS3吗？</translation>
    </message>
    <message>
      ...
      <translation>游戏正在运行中。确认关闭 RPCS3 吗？&lt;br&gt;&lt;br&gt;所有未保存的进度都将丢失！&lt;br&gt;</translation>
    </message>
  </context>
  <context>
...
文件过小。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>解析PPU指令失败。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/instruction_editor_dialog.cpp" line="124"/>
      <source>Failed to patch PPU instruction.</source>
      <translation>修补PPU指令失败。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>服务器端口必须是一个在范围1025到65535之间的整数！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>创建假面骑士</translation>
    </message>
    <message>
...
File was too small.</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Log All</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>编译PPU模块</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>玩家 %0 的压力感应模式已禁用</translation>
    </message>
    <message>
      ...
      <translation>玩家 %0 的压力感应模式已启用</translation>
    </message>
    <message>
      ...
      <translation>玩家 %0 的模拟限制器已禁用</translation>
    </message>
    <message>
      ...
      <translation>玩家 %0 的模拟限制器已启用</translation>
    </message>
    <message>
      ...
      <translation>鼠标和键盘现在被用作模拟设备。</translation>
    </message>
    <message>
      ...
      <translation>鼠标和键盘现在用作方向键。</translation>
    </message>
    <message>
      ...
      <translation>错误：游戏数据已损坏。应用程序将继续运行。</translation>
    </message>
    <message>
      ...
      <comment>Game Error</comment>
      <translation>错误：硬盘启动游戏已损坏。应用程序将继续运行。</translation>
    </message>
    <message>
...
Space needed: %0 KB</source>
      <comment>Game Error</comment>
      <translation>错误：可用空间不足。应用程序将继续运行。
所需空间：%0KB</translation>
    </message>
    <message>
...
(%0)</source>
      <comment>Error code</comment>
      <translation>文件格式无法识别 / 文件并非有效的 ELF 文件。
(%0)</translation>
    </message>
    <message>
...
(%0)</source>
      <comment>Error code</comment>
      <translation>发生了致命的系统错误，在尝试验证SELF时。SELF验证失败。
(%0)</translation>
    </message>
    <message>
...
(%0)</source>
      <comment>Error code</comment>
      <translation>输入中存在非法的多字节序列。 (%0)</translation>
    </message>
    <message>
...
(%0)</source>
      <comment>Error code</comment>
      <translation>在sys_load_param中错误的版本。
(%0)</translation>
    </message>
    <message>
...
(%0)</translation>
    ...
    <message>
      ...
      <comment>OSK Dialog</comment>
      <translation>无法打开主菜单，原因是屏幕键盘正忙！</translation>
    </message>
    <message>
...
If you have not installed [%0], go to [Remote Play] on the PS Vita system and start [Cross-Controller] from the LiveArea™ screen.</source>
      ...
      <translation>在 PS Vita 系统上启动[%0]。
如果尚未安装[%0]，请前往 PS Vita 系统的 [远程播放] 并从 LiveArea 屏幕开始使用 [Cross-Controller]。</translation>
    </message>
    <message>
      ...
      <translation>如果 PS Vita 系统的软件版本低于1.80，则必须将系统软件更新至最新版本。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择要发送的消息</translation>
    </message>
    <message>
...
主题：</translation>
    ...
    <message>
      ...
      <translation>RPCN连接错误：WolfSSL错误</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>RPCN 连接错误：无法绑定到指定的绑定 IP</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>RPCN随机错误：协议版本错误 (过时的RPCS3？)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>成功登录到RPCN！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>已发送好友请求</translation>
    </message>
    <message>
...
%0</source>
      <translation>接受请求？%0</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>放弃当前更改的设置吗？</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Audio</comment>
      <translation>时间拉伸阈值</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Debug</comment>
      <translation>纹理细节层次偏差偏移量</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>不显示隐藏的奖杯</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>进度：分析中...</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>PS3应用程序可能已经崩溃，你可以关闭它。</translation>
    </message>
    <message>
      ...
      <translation>保存状态失败：游戏正在保存中，请等待完成。</translation>
    </message>
    <message>
      ...
      <translation>保存状态失败：基于VDEC的视频/过场动画正在播放，请等待其结束或启用 libvdec.sprx。</translation>
    </message>
    <message>
      ...
      <translation>保存状态失败：无法锁定SPU状态，启用与SPU兼容模式可能可以解决此问题。</translation>
    </message>
    <message>
      ...
      <translation>保存状态失败：未能锁定SPU状态，使用SPU ASMJIT 将会解决此问题。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>检查配置(&amp;C)</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/log_viewer.cpp" line="91"/>
      <source>&amp;Show Timestamps</source>
      <translation>显示时间戳(&amp;S)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>仅最近的操作(&amp;L)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>日志文件 (*.log *.gz);;所有文件 (*.*)</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/log_viewer.cpp" line="173"/>
    ...
    <message>
      ...
      <translation>输入文本（以逗号分隔）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法打开 &apos;%0&apos;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法找到任何已启动的游戏！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>游戏角色管理</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>发送打开系统菜单命令</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>输入/输出设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>配置网络设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>自动暂停设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>退出RPCS3，将日志文件移动到自定义位置</translation>
    </message>
    <message>
      ...
      <translation>退出应用程序并将日志保存到用户自定义的位置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Exit RPCS3</source>
      <translation>退出RPCS3</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>解密 PS3 Binaries</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>从.tar文件的 PS3UPDAT.PUP 中提取文件</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.ui" line="780"/>
      <source>Show Debugger</source>
      <translation>显示 Debugger</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>为了确保 RPCS3 的持续改进，欢迎加入我们的 Patreon 小组！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>显示游戏兼容性</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>查看欢迎界面</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>模拟器全局设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>配置RPCN设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>切换到网格视图</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>创建LLVM缓存</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除自定义控制器设置(&amp;R)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Remove All Caches</source>
      <translation>删除所有缓存</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>RPCN设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Check Config</source>
      <translation>Check Config</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>System Commands</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>GHLtar 吉他</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.ui" line="1405"/>
      <source>Turntable</source>
      <translation>Turntable 转盘</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>优先使用游戏数据图标</translation>
    </message>
    <message>
...
&lt;br&gt;关于如何获取所需固件的信息，请阅读 &lt;a %0 href=&quot;https://rpcs3.net/quickstart&quot;&gt; 快速入门指南&lt;/a&gt;。</translation>
    ...
    <message>
      ...
      <translation>无法正确安装光盘。请确保光盘不在dev_hdd0/game文件夹中。</translation>
    </message>
    <message>
      ...
      <translation>所选文件已损坏或文件夹无效。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法解密数字内容。这通常是由于许可 (RAK)文件缺少或无效导致的。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>此光盘类型目前尚未被支持。</translation>
    </message>
    <message>
      ...
      <translation>保存进度数据已损坏，或者它不是 RPCS3 的存档数据。</translation>
    </message>
    <message>
      ...
      <translation>你使用的即时存档版本数据与你的RPCS3构建不匹配。</translation>
    </message>
    <message>
      ...
      <translation>游戏或 PS3 应用仍在运行或者没有完全停止。</translation>
    </message>
    <message>
      ...
      <translation>该游戏或 PS3 应用程序需要更新的固件版本。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;br /&gt;&lt;br /&gt;关于设置模拟器以及从 PS3 导出游戏的信息，请阅读：&lt;a %0 href=&quot;https://rpcs3.net/quickstart&quot;&gt; 快速入门指南&lt;/a&gt;。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择 SELF/ELF 启动</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="575"/>
      ...
      <translation>(S)ELF文件 (*BOOT.BIN * .elf * .self)；；ELF文件 (*BOOT.BIN * .elf)；；SELF文件 (EBOOT.BIN * .self)；；启动文件 (*BOOT.BIN)；；二进制文件 (*.bin)；；所有可执行文件 (*.SAVESTAT.zst *.SAVESTAT.gz *.SAVESTAT *.sprx *.SPRX *.self *.SELF *.bin *.BIN *.prx *.PRX *.elf *.ELF *.o *.O)；；所有文件 (*.*)</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="623"/>
      <source>(S)ELF files (*.elf *.self);;ELF files (*.elf);;SELF files (*.self);;All files (*.*)</source>
      <translation>(S)ELF文件(*.elf *.self);;ELF文件(*.elf);;SELF文件(*.self);;所有文件(*)</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="655"/>
      <source>Select Savestate To Boot</source>
      <translation>选择即时存档启动</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="655"/>
      <source>Savestate files (*.SAVESTAT *.SAVESTAT.zst *.SAVESTAT.gz);;All files (*.*)</source>
      <translation>即时存档文件 (*.SAVESTAT, *.SAVESTAT.zst, *.SAVESTAT.gz);;所有文件 (*.*)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择 ISO</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="714"/>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="2570"/>
      <source>ISO files (*.iso);;All files (*.*)</source>
      <translation>ISO 文件 (*.iso);;所有文件 (*.*)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>所有相关文件 (*.pkg, *.PKG, *.rap, *.RAP, *.edat, *.EDAT) ;;包文件 (*.pkg, *.PKG) ;;Rap文件 (*.rap, *.RAP) ;;Edat文件 (*.edat, *.EDAT) ;;所有文件 (*.*)</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="972"/>
      <source>RPCS3 Package Installer</source>
      <translation>RPCS3 包安装器</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="972"/>
...
%2</translation>
    ...
    <message>
      ...
      <translation>成功安装了软件！</translation>
    </message>
    <message>
...
Tried to install: %3</source>
      <translation>无法在现有数据基础上安装该软件包。
更新适用于版本 %1，当前已安装版本为 %2。
...
待安装版本：%2</translation>
    ...
    <message>
      ...
      <translation>没有数据被安装</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1212"/>
      <source>Package cannot be installed on top of the current data.
...
Please add RPCS3 to your anti-virus&apos; whitelist or use better anti-virus software.</source>
      <translation>未能安装软件包：
%1！
这很可能是由于杀毒软件错误拦截导致安装被干扰。
请将RPCS3添加到杀毒软件的白名单中，或使用更可靠的杀毒软件</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1232"/>
      <source>Select MSELF To extract</source>
      <translation>选择 MSELF 提取</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1232"/>
      <source>All mself files (*.mself *.MSELF);;All files (*.*)</source>
      <translation>所有mself文件 (*.mself *MSELF);;所有文件 (*.*)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择 PS3UPDAT.PUP 安装</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1253"/>
      ...
      <translation>PS3更新文件 (PS3UPDAT.PUP)；；所有PUP文件 (*.pup *.PUP)；；所有文件 (*.*)</translation>
    </message>
    <message>
      ...
      <translation>RPCS3固件安装器</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1257"/>
...
请等待...</translation>
    ...
    <message>
      ...
      <translation>固件安装失败：所选的固件文件无法打开。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>固件安装失败：提供的文件不是PUP文件。</translation>
    </message>
    <message>
...
Overwrite current installation with version %2?</source>
      <translation>已经安装了%1版本的固件。
用%2版本覆盖当前的安装吗？</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1553"/>
      <source>Installing firmware version %1
Please wait...</source>
      <translation>安装固件版本 %1
请等待...</translation>
    </message>
    <message>
      ...
      <translation>固件安装失败：固件无法被解压缩</translation>
    </message>
    <message>
...
请将RPCS3添加到杀毒软件的白名单中，或使用更可靠的杀毒软件。</translation>
    ...
    <message>
      ...
      <translation>所有二进制文件 (*.bin、*.BIN、*.self、*.SELF、*.sprx、*.SPRX、*.sdat、*.SDAT、*.edat、*.EDAT)；；仅限二进制文件 (*.bin、*.BIN)；；仅限SELF文件 (*.self、*.SELF)；；仅限SPRX文件 (*.sprx、*.SPRX)；；仅限SDAT/EDAT文件 (*.sdat、*.SDAT、*.edat、*.EDAT)；；所有类型文件 (*.*)</translation>
    </message>
    <message>
...
And is logged with some sceNpDrm* functions when the game/application which owns &quot;%0&quot; is running.</source>
      <translation>提示：KLIC（即 KLicense 密钥）为 16 字节长度的字符串。（共 32 个十六进制字符，日志消息中可添加前缀 “KLIC=0x”）
当持有 “%0” 的游戏 / 应用程序运行时，该密钥会随部分 sceNpDrm 系列函数被记录至日志。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1703"/>
      <source>Enter KLIC of %0</source>
      <translation>请输入KLIC的%0</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1704"/>
      <source>Decryption failed with provided KLIC.
%0</source>
      <translation>使用提供的KLIC进行解密失败。
%0</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="1704"/>
...
Would you like to precompile caches and install shortcuts to the installed software? (%2 new software detected)
      ...
      <translation>%1
您想要预编译缓存并为已安装的软件创建快捷方式吗？（检测到新软件 %2）</translation>
    </message>
    <message>
...
Make sure that RPCS3.log and RPCS3.log.gz are writable and can be created without permission issues.</source>
      <translation>未能找到日志文件。
请确保可以访问并创建RPCS3.log和RPCS3.log.gz，且在没有权限问题的情况下可进行写操作。</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>自动更新在当前系统上不可用。</translation>
    </message>
    <message>
...
Undetectable games (zombies) as well as corrupted games will be removed from the game list file (games.yml)</source>
      <translation>从游戏列表中删除无效的游戏路径？
无法检测到的游戏以及损坏的游戏将从游戏列表文件（games.yml）中删除。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>%0 游戏已从游戏列表中删除</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/main_window.cpp" line="3787"/>
      <source>Remove firmware cache?</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>原始图像预览选项</translation>
    </message>
    <message>
...
Warning: this may reduce performance of the search.</source>
      <translation>使用字符串模式时，字符串与内存中的字符大小写均不敏感。
警告：这可能会降低搜索性能。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>正则表达式指令</translation>
    </message>
    <message>
...
RegEx: search an instruction containing text that matches the regular expression input.</source>
      <translation>字符串：在内存中搜索指定的字符串。 
十六进制字节/整数：在内存中搜索十六进制值。空格、逗号、“0x”、“0X”、“x”、“h”、“H” 可用于分隔字节，但非必需。 
双精度浮点数（Double）：将输入字符串解释为 64 位精度浮点值进行搜索。搜索基于精确的二进制表示，即 -0 != 0。 
单精度浮点数（Float）：将输入字符串解释为 32 位精度浮点值进行搜索。同样基于精确表示，即 -0 != 0。 
指令（Instruction）：搜索包含该字符串文本的指令。 
正则表达式（RegEx）：搜索指令中与输入正则表达式匹配的文本。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/memory_viewer_panel.cpp" line="327"/>
      <source>SPU RegEx-Instruction</source>
      <translation>SPU Regex 指令</translation>
    </message>
    <message>
...
Tip: SPU floats are commented along forming instructions.</source>
      <translation>SPU指令：搜索一个SPU指令包含字符串文本。用于在嵌入式SPU图像内搜索指令。
提示：SPU浮点数沿形成指令时被注释掉。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/memory_viewer_panel.cpp" line="357"/>
      <source>%0 mode(s) selected</source>
      <translation>选择了%0模式</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>创建 minifig 文件失败！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/dimensions_dialog.cpp" line="473"/>
      <source>Failed to create minifig file:
%1</source>
      <translation>创建 minifig 文件失败：
%1</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>音频文件 (*.mp3;*.wav;*.aac;*.ogg;*.flac;*.m4a;*.alac);;所有文件 (*.*)</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>电池状态和LED</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>控制器设置：[%0] %1</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>PS Move 动态控制器</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>PS3 手柄</translation>
    </message>
    <message>
      ...
      <translation>劲舞革命 跳舞垫</translation>
    </message>
    <message>
      ...
      <translation>DJ Hero 唱盘</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>摇滚乐队专业版（鼓套装）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>吉他英雄 （吉他）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>摇滚革命（鼓）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Tony Hawk RIDE 滑板</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>必须选择一个不包含 &apos;.&apos; 的名称</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/pad_settings_dialog.cpp" line="1921"/>
      <source>Please choose a non-existing name</source>
      <translation>请选择一个不存在的名字</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法删除默认配置 &apos;%0&apos;。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>确认要删除配置 &apos;%0&apos; 吗？</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/pad_settings_dialog.cpp" line="1953"/>
    ...
    <message>
      ...
      <translation>已删除的配置</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/pad_settings_dialog.cpp" line="1968"/>
...
当前选定的配置为 &apos;%1&apos;。</translation>
    ...
    <message>
      ...
      <translation>%0 按钮 &lt;b&gt;%1&lt;/b&gt;被&lt;b&gt;玩家 %2&lt;b&gt;被重复分配了至少两次。请考虑更改设置。&lt;br&gt;&lt;br&gt;是否仍要继续？&lt;b&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>XInput 手柄 #%0</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>清空面板(&amp;C)</translation>
    </message>
    <message>
...
The offset has to be a hexadecimal number with 8 digits at most.</source>
      <translation>补丁的偏移无效。
偏移必须是一个最多包含8位的十六进制数。</translation>
    </message>
    <message>
...
不允许导出无效的补丁。</translation>
    ...
    <message>
      ...
      <translation>补丁.yml 文件 (*.yml);;所有文件 (*.*)</translation>
    </message>
    <message>
...
Make sure that all the patches located in &quot;%0&quot; contain the proper formatting that is required for the Patch Manager Version %1.</source>
      <translation>某些补丁可能不兼容 RPCS3 当前版本的补丁管理器。

确保所有位于“%0”中的补丁都符合补丁管理器版本 %1 所需的正确格式。</translation>
    </message>
    <message>
...
This action is immediate and irreversible!</source>
      <translation>你真的要删除选定的补丁吗？
此操作立即完成且不可逆！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除补丁成功！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无法删除补丁！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>要对补丁文件执行什么操作？</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>没有需要导入的内容</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/patch_manager_dialog.cpp" line="1067"/>
      <source>None of the found %0 patches were imported.%1</source>
      <translation>找到的 %0 补丁全部未导入。%1</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>补丁文件通过了验证。</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>补丁文件中发现了错误。</translation>
    </message>
    <message>
      ...
      <translation>要查看错误日志，请点击“显示详细信息”。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>您的补丁文件已经是最新版本。</translation>
    </message>
    <message>
...
要进行更新吗？</translation>
    ...
    <message>
      ...
      <translation>补丁文件已经更新到最新</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/patch_manager_dialog.cpp" line="1310"/>
...
%0</translation>
    ...
    <message>
      ...
      <translation>下载的补丁文件中发现了错误。</translation>
    </message>
    <message>
      ...
      <translation>所有版本 - 警告：这些补丁适用于所有游戏！</translation>
    </message>
    <message>
...
Reorder and/or exclude them if needed, then click &quot;Install&quot; to proceed.</source>
      <translation>即将安装多个软件包。
如需调整，请重新排序或筛选软件包，然后点击“安装”继续操作。</translation>
    </message>
    <message>
      ...
      <translation>您想要预编译缓存并为已安装的软件创建快捷方式吗？</translation>
    </message>
    <message>
...
所需磁盘空间: %3</translation>
    ...
    <message>
      ...
      <translation> - &lt;b&gt;空间不足&lt;/b&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>PS Move 追踪器设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>显示所有轮廓</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>配置原始鼠标控制器</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>重置所有玩家的设置？</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>收到错误消息！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/recvmessage_dialog_frame.cpp" line="73"/>
      <source>You must select a message!</source>
      <translation>你必须选择一条消息！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>解析寄存器值时发生错误！</translation>
    </message>
    <message>
      ...
      <translation>确认后取消预存</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/register_editor_dialog.cpp" line="195"/>
      <location filename="./rpcs3/rpcs3qt/register_editor_dialog.cpp" line="217"/>
      <source>Reservation is inactive</source>
      <translation>预存未生效</translation>
    </message>
    <message>
...
Selecting ignore starts the emulator without Vulkan support.</source>
      <translation>查询兼容Vulkan的设备耗时过长。这通常是由图形驱动程序故障导致的，重新安装驱动可能会解决问题。

选择“忽略”会在没有Vulkan支持的情况下启动模拟器。</translation>
    </message>
    <message>
...
No graphics will be rendered.</source>
      <translation>此Mac不支持Vulkan。

将不会进行图形渲染。</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>RPCN：账户</translation>
    </message>
    <message>
...
- Your email won&apos;t be used for anything beyond sending you this token or the password reset token.
      ...
      <translation>需要电子邮件地址，请注意:
- 需要有效的电子邮件以接收验证你的帐户的令牌。
- 电子邮件仅用于发送此令牌或重置密码令牌。
    ...
    <message>
      ...
      <translation>RPCN：创建帐户</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="292"/>
...
这是正确的吗？</translation>
    ...
    <message>
      ...
      <translation>创建账户时出现错误！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="313"/>
...
%0</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>RPCN: 编辑账户</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>用户名必须在 3 到 16 个字符之间，只能包含 &apos;-&apos;, &apos;_&apos; 或字母数字字符。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>收到的令牌应为16个字符长，只包含0至9以及A至F这16个字符。</translation>
    </message>
    <message>
      ...
      <translation>该服务器不提供邮箱验证功能，也无不需要令牌！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>每24小时只能请求一次令牌邮件！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>发送令牌时发生错误！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="865"/>
...
Note that the reset password token is different from the email verification token.</source>
      <translation>请确认是否已有重设密码的令牌？注意，重设密码的令牌与电子邮件验证令牌是不同的。</translation>
    </message>
    <message>
      ...
      <translation>请输入您创建账户时使用的电子邮件：</translation>
    </message>
    <message>
      ...
      <translation>该服务器不提供邮箱验证功能，也不支持更改密码！</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>重设密码的令牌已成功发送！</translation>
    </message>
    <message>
      ...
      <translation>请输入您收到的密码重置令牌：</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>用户名/令牌组合无效！</translation>
    </message>
    <message>
...
%0</translation>
  ...
  <context>
    ...
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="425"/>
      <source>You must enter a hostname for the server!</source>
      <translation>必须为服务器输入一个主机名！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>RPCN: 电子邮件</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>再次输入邮箱地址:</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>你需要输入一个有效的邮箱地址！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>必须输入密码！</translation>
    </message>
  </context>
  <context>
...
-令牌只应包含0-9和A-F</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>用户名缺失！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="472"/>
      <source>You must enter a username!</source>
      <translation>必须输入一个用户名！</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>确认账号删除</translation>
    </message>
    <message>
...
To confirm, type your username below and click &quot;Yes&quot;.
      ...
      <translation>你确定要注销 RPCN 账号 &quot;%1&quot;？

重要提示：
注销账号后，你的用户名和邮箱将被列入黑名单，为期 3 个月。
如需确认，请在下方输入用户名并点击确认 &quot;是的&quot;。
</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="682"/>
      <source>Type your username to confirm</source>
      <translation>输入你的用户名以确认</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>账号或密码无效。</translation>
    </message>
    <message>
      ...
      <translation>无法删除当前登录的账号。</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
      ...
      <translation>账号已删除</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/rpcn_settings_dialog.cpp" line="723"/>
      <source>Your account has been successfully deleted.</source>
      <translation>你的账号已成功删除。</translation>
    </message>
  </context>
  <context>
...
%0</translation>
    ...
    <message>
      ...
      <translation>发生数据库错误。请稍后重试。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>在编辑RPCN账号信息之前，需要停止模拟！</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>选择记录(&amp;S)</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>选择一个项目查看详细信息</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>正在加载存档</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/save_manager_dialog.cpp" line="246"/>
      <source>Loading save data, please wait...</source>
      <translation>正在加载存档，请稍等......</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/save_manager_dialog.cpp" line="246"/>
      <source>Cancel</source>
...
%1？</translation>
    ...
    <message numerus="yes">
      ...
      <translation>
        <numerusform>您确定要删除这些 %n 项吗？</numerusform>
      </translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>打开存档目录(&amp;O)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>最后修改日期：%1</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>保存状态管理器</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>显示保存状态</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除保存状态 &apos;%0&apos;吗?</translation>
    </message>
    <message>
...
%0?</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>选择要发送消息的好友：</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>发送消息时出现错误！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/sendmessage_dialog_frame.cpp" line="71"/>
      <source>You must select a friend!</source>
      <translation>你必须选择一个好友！</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>启用SPU循环检测</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/settings_dialog.ui" line="209"/>
      <source>Max Power Saving CPU-preemptions</source>
      <translation>CPU 功耗限制</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>将鼠标指向一个选项以在这里显示描述。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>ZCULL 精确度</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>启用 3D 支持</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>写入颜色缓冲区</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>音频缓冲持续时间: 0 ms</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>DJ Hero 模拟唱盘</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>摄像头处理程序</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>将覆盖层输入锁定至玩家 1</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>设置确认按钮</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>清空 /dev_hdd0/tmp/</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>IP/Hosts 交换机</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>PSN 设置</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Show RPCN popups</source>
      <translation>显示 RPCN 弹出窗口</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Show PPU compilation hint</source>
      <translation>显示PPU编译提示</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Show pressure intensity toggle hint</source>
      <translation>显示压感模式切换提示</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>全屏模式下忽略双击操作</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>启动时调整游戏窗口大小</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>着色器加载界面</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Framerate datapoints:</source>
      <translation>帧速率取样点：</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/settings_dialog.ui" line="3689"/>
      <source>Frametime datapoints:</source>
      <translation>帧时间取样点：</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>使用自定义 UI颜色</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>存档管理器图标</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Discord状态：</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Log着色器程序</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>钩接静态函数</translation>
    </message>
    <message>
...
Each option heavily depends on the game and on your CPU, it&apos;s recommended to try each option to find out which performs the best.</source>
      <translation>在线程数少于 %0 的 CPU 上，不支持更改线程调度器。

控制 RPCS3 利用系统线程的方式。
每个选项很大程度上取决于游戏和 CPU，建议尝试每个选项以找出性能最佳项。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Resolution</comment>
      <translation>720p (推荐)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>无需为 %0 渲染</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>时间延展阈值：%0 %</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>最大体积：%0 MB</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>请勿修改libsysutil库，仅用于开发目的，可能会导致游戏崩溃。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>帧速率取样点: %0</translation>
    </message>
    <message>
      ...
      <translation>帧时间取样点: %0</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
      ...
      <comment>Game window title</comment>
      <translation>游戏窗口标题格式</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>创建新的安装ID失败！</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <comment>Stylesheets</comment>
      <translation>Native  (%0)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>删除过时的设置？</translation>
    </message>
    <message>
      ...
      <translation>当前配置文件包含一个或多个过时的条目。&lt;br&gt;请注意，删除这些条目可能导致其在 RPCS3 的其它版本中失效。&lt;br&gt;&lt;br&gt;是否希望程序现在删除过时条目？&lt;br&gt;此次更改只有在保存配置后生效。</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>游戏窗口快捷键</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>开/关帧率限制</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>静音/取消静音音频</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>切换基于鼠标的陀螺仪</translation>
    </message>
  </context>
  <context>
...
%1</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>打开 Skylander 文件失败！</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/skylander_dialog.cpp" line="786"/>
      <source>Failed to open the skylander file(%1)!
File may already be in use on the portal.</source>
      <translation>打开 Skylander 文件失败！ (%1)！
该文件可能已被端口占用。</translation>
    </message>
    <message>
...
The file format is .wav and you should try to make the sounds as short as possible.</source>
      <translation>可在此处为 RPCS3 叠加层导入音效。
文件格式为.wav，建议使用时长短的音效。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>系统命令 | %1</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>选择自定义命令</translation>
    </message>
    <message>
...
请联系开发人员。</translation>
    ...
    <message>
      ...
      <translation>请先选择一个合适的自定义命令。</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>奖杯查看选项</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>打开奖杯目录(&amp;O)</translation>
    </message>
    <message>
...
Check the log for more information.</source>
      <translation>自动更新过程中出现错误。
请检查日志以获取更多信息。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;br&gt;您可以访问 &lt;a href=&quot;https://rpcs3.net/patreon&quot;&gt;RPCS3 Patreon&lt;/a&gt;来为我们的项目提供支持。&lt;br&gt;</translation>
    </message>
    <message>
      ...
      <translation>RPCS3 发表了新的稳定版已发布！&lt;br&gt;&lt;br&gt;当前版本: %0 (%1)&lt;br&gt;最新版本: %2 (%3)&lt;br&gt;%4&lt;br&gt;是否进行更新？</translation>
    </message>
    <message>
      ...
      <translation>RPCS3 发布了新版本!&lt;br&gt;&lt;br&gt;当前版本: %0 (%1)&lt;br&gt;最新版本: %2 (%3)&lt;br&gt;您已落后最新版本 %4 。&lt;br&gt;%5&lt;br&gt;是否进行更新？</translation>
    </message>
    <message>
      ...
      <translation>当前使用的是自定义或 PR 构建版本。&lt;br&gt;&lt;br&gt;最新版本: %0 (%1)&lt;br&gt;当前已落后最新版本 %2。&lt;br&gt;%3&lt;br&gt;是否要更新到 RPCS3 官方最新版本？</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
      ...
      <translation>在尝试更新之前，请停止模拟操作。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>正在更新RPCS3</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/update_manager.cpp" line="765"/>
      <source>Update successful!&lt;br&gt;RPCS3 will now restart.&lt;br&gt;</source>
      <translation>更新成功！&lt;br&gt;RPCS3 将重新启动。&lt;br&gt;</translation>
    </message>
  </context>
  <context>
...
新用户名:</translation>
    ...
    <message>
      ...
      <translation>名称必须在3到16个字符之间，只包含字母、数字、下划线和短横线。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/user_manager_dialog.cpp" line="321"/>
...
Stop the emulator now?</source>
      <translation>为了更改用户，必须首先停止模拟器。

现在停止模拟器吗？</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>打开用户目录(&amp;O)</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>重置所有文件系统目录吗？</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>使用了 %0 目录：</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>重置所有条目和文件系统目录？</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>欢迎来到RPCS3</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;br/&gt;&lt;span style=&quot; font-weight:600; color:#ff0000;&quot;&gt;RPCS3 不支持盗版。您必须转存你自己的游戏。&lt;/span&gt;&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>使用深色主题（稍后可配置）</translation>
    </message>
    <message>
...
Otherwise, further discussion and support can be found on the %3 or on our %4 server.</source>
      <translation>开始使用前，您必须首先安装 %0。
请参阅官方网站上的 %1 指南以获取更多信息。
如有其他问题，请参阅 %2。
此外，可进一步在 %3 或我们的 %4 服务器上讨论与获取支持。</translation>
    </message>
    <message>
      <location filename="./rpcs3/rpcs3qt/welcome_dialog.cpp" line="39"/>
      <source>PlayStation 3 firmware</source>
      <translation>PlayStation 3 固件</translation>
    </message>
    <message>
