...
<context>
    ...
    <message>
        ...
        <translation>Укажите ID системного или функционального вызова ниже. Вам необходимо использовать шестнадцатеричный ID.</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/auto_pause_settings_dialog.cpp" line="227"/>
        <source>Currently it gets an id of &quot;Unset&quot;.</source>
        <translation>В данный момент он получает идентификатор &quot;Unset&quot;.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Дисковая игра</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/localized.h" line="32"/>
        <source>HDD Game</source>
        <translation>Игра с жёсткого диска</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PSP Игра</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ремастеры PSP</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Данные сохранений PS3</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/localized.h" line="57"/>
        <source>PSP Minis Save Data</source>
        <translation>Данные сохранений PSP Minis</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>UNMAP</source>
        <translation>Снять раскладку</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Введите %0 для %1, таймаут через %2 %3</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/emulated_logitech_g27_settings_dialog.cpp" line="321"/>
        <source>axis</source>
...
Current location:
%0</source>
        <translation>RPCS3 никогда не должен запускаться из временной папки!  
...
Current location:
%0</source>
        <translation>RPCS3 никогда не должен запускаться из архива!  
Пожалуйста, установите RPCS3 в постоянное место.  
Текущее местоположение:  
%0</translation>
    </message>
...
Current location:
%0</source>
        <translation>RPCS3 никогда не должен запускаться из папки, синхронизируемой с OneDrive!
        Пожалуйста, установите RPCS3 в место которое не синхронизованно с OneDrive.
        Текущее местоположение:
        %0</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Невозможно выполнить несколько установок одновременно!</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3.cpp" line="1312"/>
        <source>Missing command-line arguments!</source>
        <translation>Не найдены аргументы командной строки!</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3.cpp" line="1312"/>
        <source>Cannot run no-gui mode without boot target.
Terminating...</source>
        <translation>Невозможно запустить режим без графического интерфейса без указания целевой системы загрузки.
        Программа завершает работу...</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/debugger_frame.cpp" line="708"/>
        <source>Pause the SPU Thread!</source>
        <translation>Приостановить поток SPU!</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/debugger_frame.cpp" line="708"/>
        <source>Cannot perform SPU capture due to the thread needing manual pausing!</source>
        <translation>Невозможно выполнить захват SPU, так как поток требует ручной приостановки!</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/emulated_logitech_g27_settings_dialog.cpp" line="82"/>
        <source>Steering</source>
        <translation>Управление рулём</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Переключить передачу вверх</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/emulated_logitech_g27_settings_dialog.cpp" line="87"/>
        <source>Shift down</source>
        <translation>Переключить передачу вниз</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отслеживание PS Move пока что не поддерживается на данной ОС.</translation>
    </message>
</context>
<context>
    <name>Tooltips</name>
...
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
        <translation>Эти библиотеки по умолчанию работают в режиме LLE (нижний список), выбор переключит их на HLE.
LLE — &quot;Эмуляция низкого уровня&quot;, будет использоваться код функций из выбранного SPRX-файла для экспортируемых функций прошивки.
HLE — &quot;Эмуляция высокого уровня&quot;, вместо этого будет использоваться альтернативный код эмулятора для экспортируемых функций прошивки.
Если выбрать неверно, игры не будут работать! Если не уверены, оставьте оба списка пустыми.
HLE для всех SPRX позволяет запускать игры без установленной прошивки. (экспериментально)</translation>
    </message>
    <message>
...
HLE - &quot;High Level Emulated&quot;, alternative emulator code will be used instead for exported firmware functions.
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
        <translation>Эти библиотеки по умолчанию работают в режиме HLE (верхний список), выбор переключит их на LLE.
LLE — &quot;Эмуляция низкого уровня&quot;, будет использоваться код функций из выбранного SPRX-файла для экспортируемых функций прошивки.
HLE — &quot;Эмуляция высокого уровня&quot;, вместо этого будет использоваться альтернативный код эмулятора для экспортируемых функций прошивки.
Если выбрать неверно, игры не будут работать! Если не уверены, оставьте оба списка пустыми.
HLE для всех SPRX позволяет запускать игры без установленной прошивки. (экспериментально)</translation>
    ...
    <message>
        ...
        <translation>Выберите LLE. (HLE по умолчанию)</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/tooltips.h" line="26"/>
        <source>Select to HLE. (LLE by default)</source>
        <translation>Выберите HLE. (LLE по умолчанию)</translation>
    </message>
    <message>
...
Causes some software to behave differently than on retail hardware.</source>
        <translation>Увеличивает объем доступной системной памяти, чтобы она соответствовала DECR-консоли и даже превосходила её.
Приводит к тому, что некоторые программы ведут себя иначе, чем на розничном оборудовании.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Точно обрабатывает операции DMA SPU.</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
        <translation>Наследованный параметр. Исправляет значения вектора результатов в режиме Non-Java для PPU LLVM.
...
You shouldn&apos;t disable it if your CPU supports FMA.</source>
        <translation>Используйте точные инструкции FMA двойной точности в бэкендах PPU и SPU.  
Отключение этой опции может дать заметный прирост производительности, если ваш процессор не поддерживает FMA, но также может привести к появлению скрытых ошибок, которые иначе бы не возникли.  
Не рекомендуется отключать эту опцию, если ваш процессор поддерживает FMA.</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/tooltips.h" line="33"/>
        <source>Fixup NaN results in vector instructions in PPU backends.
If unsure, do not modify this setting.</source>
        <translation>Исправляет значения NaN в векторных инструкциях в бэкендах PPU.  
Если не уверены, не изменяйте этот параметр.</translation>
    </message>
    <message>
        ...
        <translation>Прекратить запись любых логов после запуска игры. Не используйте, если не считаете это необходимым.</translation>
    </message>
    <message>
        ...
        <translation>Инициализирует память целевого буфера рендеринга с использованием памяти виртуальной машины.</translation>
    </message>
    <message>
        <location filename="./rpcs3/rpcs3qt/tooltips.h" line="37"/>
        <source>Writes depth buffer values to vm memory.</source>
        <translation>Записывает значения буфера глубины в память виртуальной машины.</translation>
    </message>
    <message>
...
This can fix graphics corruption observed when Read Color or Read Depth options are enabled.</source>
        <translation>Соблюдать конфигурацию тайлинга памяти RSX при записи данных GPU в память виртуальной машины.  
Это может исправить графические искажения, наблюдаемые при включённых опциях Read Color или Read Depth.</translation>
    </message>
    <message>
        ...
        <translation>Отключает загрузку и сохранение шейдеров из и в кэш шейдеров в каталоге данных.</translation>
    </message>
    <message>
        ...
        <translation>Позволяет GPU хоста синхронизироваться напрямую с CELL. Это снижает производительность, но отображает реальное состояние объектов GPU для гостевого CPU. Может помочь устранить визуальные артефакты и сбои, но за счет снижения производительности. Используйте с осторожностью.</translation>
    </message>
    <message>
...
This option incurs a performance penalty as well as the risk of visual artifacts but can yield crisper visuals when MSAA is enabled.</source>
        <translation>Принудительно заставляет MSAA использовать возможности resolve хостовой GPU&apos;а для всех операций выборки.
Этот параметр снижает производительность и может вызывать визуальные артефакты, но при включённом MSAA позволяет получить более чёткое изображение.</translation>
    </message>
    <message>
...
This option is only needed by developers to debug problems with texture cache memory protection.</source>
        <translation>Принудительно выполняет вызовы управления памятью хоста синхронно, вместо асинхронной обработки.
Это может вызвать сильное падение производительности и заикания в некоторых играх.
Этот параметр нужен только разработчикам для отладки проблем с защитой памяти кэша текстур.</translation>
    </message>
    <message>
...
This option is only needed for a select number of games.</source>
        <translation>Отключает оптимизацию спин-циклов SPU GETLLAR.
Это может вызвать сильное падение производительности и заикания во многих играх.
Этот параметр нужен только для ограниченного числа игр.</translation>
    </message>
    <message>
...
This increases CPU usage, this setting is beneficial for high-threaded CPUs (12+) with select number of games.</source>
        <translation>Включает спин-циклы SPU RdEventStat.
Это увеличивает нагрузку на процессор; данный параметр полезен для процессоров с большим числом потоков (12+) в некоторых играх.</translation>
    </message>
    <message>
...
· Relaxed changes the synchronization method completely and can greatly improve performance in some games or completely break others.</source>
        <translation>Изменяет поведение синхронизации отчёта ZCULL. Экспериментируйте, чтобы найти лучший вариант для вашей игры. Для большинства игр рекомендуется режим Approximate.
· Precise наиболее точно соответствует поведению PS3. Требуется для корректного отображения в некоторых играх, таких как Demon&apos;s Souls и The Darkness.
· Approximate — гораздо более быстрый способ генерации данных окклюзии, который может не всегда совпадать с тем, что генерирует PS3. Хорошо работает с большинством игр для PS3.
· Relaxed полностью изменяет метод синхронизации и может значительно повысить производительность в некоторых играх или полностью сломать другие.</translation>
    </message>
    <message>
...
Limiting the number of threads is likely to cause crashes; it&apos;s recommended to keep this at the default value.</source>
        <translation>Ограничивает максимальное количество потоков SPURS в каждой группе потоков.
В некоторых случаях может повысить производительность, особенно на системах с ограниченным числом аппаратных потоков.
Ограничение числа потоков может привести к сбоям; рекомендуется оставить значение по умолчанию.</translation>
    </message>
    <message>
...
&apos;As Host&apos; использует стандартную точность операционной системы, тогда как &apos;All Timers&apos; пытается её улучшить.
&apos;Usleep Only&apos; ограничивает корректировки только системным вызовом usleep.
Может непредсказуемо повлиять на производительность.</translation>
    </message>
    <message>
...
&quot;Atomic &amp; Ordered&quot; is the most accurate but it is the slowest and without much stability benefit in games.</source>
        <translation>«Fast» — наименее точная настройка, RSX не эмулирует атомарный FIFO-буфер.  
«Atomic» значительно повышает стабильность во многих играх при минимальном снижении производительности.  
«Atomic &amp; Ordered» — самая точная настройка, но самая медленная и не даёт существенного прироста стабильности в играх.</translation>
    </message>
    <message>
...
Affects timing of events which rely on these signals.</source>
        <translation>Регулирует частоту сигналов вертикальной синхронизации, отправляемых эмулятором.  
Влияет на синхронизацию событий, зависящих от этих сигналов.</translation>
    </message>
    <message>
...
Влияет на программное обеспечение, использующее системное время для вычисления таких вещей, как динамические временные шаги.</translation>
    </message>
    <message>
...
It is recommend to adjust this at 20µs to 40µs increments until the best value for optimal stability is reached.</source>
        <translation>Управляет временем, которое требуется RSX для начала обработки после пробуждения процессором Cell.  
Увеличение задержки пробуждения повышает стабильность, но слишком большие значения могут снизить производительность RSX/GPU.  
Рекомендуется изменять значение с шагом 20–40 мкс до достижения оптимальной стабильности.</translation>
    </message>
    <message>
...
Right-click a game in the game list and choose &quot;Configure&quot; instead.</source>
        <translation>Щёлкните правой кнопкой мыши по игре в списке и выберите &quot;Настроить&quot;.</translation>
    </message>
    <message>
...
Use &apos;Fast&apos; to use a faster but hacky version. This option is internally disabled for NVIDIA GPUs due to causing GPU hangs.</source>
        <translation>Определяет, как планировать асинхронные вычислительные задачи GPU при использовании асинхронной потоковой передачи.  
Используйте режим &apos;Safe&apos; для более соответствующего спецификациям поведения с небольшой нагрузкой на CPU. Этот параметр работает на всех устройствах.  
Используйте &apos;Fast&apos; для более быстрой, но менее корректной версии. Этот вариант внутренне отключён для GPU NVIDIA из-за возможных зависаний.</translation>
    </message>
    <message>
...
Disabling it may fix some artifacts, especially on Apple GPUs, at the cost of performance.</source>
        <translation>Отключает Fast Math для шейдеров MSL, что может нарушать стандарт IEEE 754.  
Отключение может исправить некоторые артефакты, особенно на видеокартах Apple, за счёт снижения производительности.</translation>
    </message>
    <message>
...
Do note that the savestate file is not gone completely, just ignored by RPCS3. You can manually relaunch it if needed.</source>
        <translation>Когда этот режим включён, эмуляция завершает работу при сохранении, а файл состояния скрывается после загрузки, предотвращая повторное использование в RPCS3.  
Этот режим похож на гибернацию эмуляции: если вы не хотите жульничать с помощью сохранений при игре, рассмотрите возможность использования этого режима.  
Учтите, что файл состояния полностью не удаляется, а просто игнорируется RPCS3. При необходимости его можно запустить вручную.</translation>
    </message>
    <message>
...
When this mode is off, some games may not allow making a savestate and show an SPU pause error in the log.</source>
        <translation>Когда этот режим включён, эмуляция SPU отдаёт приоритет совместимости с сохранениями, однако это может слегка снизить производительность.  
Когда режим выключен, некоторые игры могут не позволять создавать сохранения и показывать ошибку паузы SPU в журнале.</translation>
    </message>
    <message>
...
This allows players to prepare for gameplay without being thrown into the action immediately.</source>
        <translation>Когда этот режим включён, сохранения загружаются и приостанавливаются на первом кадре.  
Это позволяет игрокам подготовиться к игровому процессу, не начиная сразу действие.</translation>
    </message>
    <message>
